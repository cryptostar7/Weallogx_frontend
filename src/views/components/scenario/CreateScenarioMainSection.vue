          ...
          <div class="main-form-div">
            ...
            <div class="form-wrapper side-grey-line">
              <div class="form-wrapper-inner">
                <SelectDropdown :list="clients" label="Client" id="clientSelected" />
                <hr class="hr-separator" size="1.25" />
                <SelectDropdown :list="existingScenarioList" label="Use Existing Scenario" id="existingScenario" />
                ...
                <div class="form-group-wrapper">
                  <div class="form-group">
                    ...
                    <input type="text" id="clientAge" value="" class="form-control" />
                  </div>
                  <div class="form-group">
                    ...
                    <div class="form-group-wrapper">
                      <div class="form-group">
                        ...
                        <div class="percent-input-div">
                          <input type="text" id="firstTaxRate" class="form-control percent-input" v-model="firstTaxRate"
                            required />
                      ...
                      <table class="table tax-rate-table text-center" id="scheduleTaxRateTable">
                        ...
                        <tbody>
                          ...
                          <tr v-for="index in Number(illustrateYear)" :key="index">
                            ...
                            <td>
                              <div class="p-relative table-input-div percent-input-div"><input type="text"
                                  class="form-control percent-input" required><span class="percent-span">%</span></div>
                            </td>
                          </tr>
                        </tbody>
                      </table>
