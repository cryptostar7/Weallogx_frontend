            ...
            <form action="">
                <div class="row">
                    <div class="col-md-6 summaryInputsDiv">
                        ...
                        <input v-if="$props.data.performance_multiplier_fixed_value" type="text" class="form-control NAData" :value="$props.data.performance_multiplier ? $props.data.performance_multiplier_fixed_value_multiplier : 'N/A'" readonly>
                        <p v-else class="Schedule-para" data-bs-toggle="modal" data-bs-target="#exampleModal">Scheduled 
                    ...
                    <div class="col-md-6 summaryInputsDiv">
                        ...
                        <input type="text" class="form-control NAData" :value="$props.data.performance_multiplier ? $props.data.performance_multiplier_fixed_value_start_year : 'N/A'" readonly>
                    </div>
                    <div class="col-md-6 summaryInputsDiv">
                        <label for="client name">Flat Credit/Bonus</label>
                        <input v-if="$props.data.performance_multiplier_fixed_value" type="text" class="form-control NAData" :value="$props.data.flat_fixed_value ? $props.data.flat_fixed_credit_bonus : 'N/A'" readonly>
                        <p v-else class="Schedule-para" data-bs-toggle="modal" data-bs-target="#exampleModal">Scheduled 
                            <button type="button" class="schedule-icon-btn">
                                <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.375" y="0.375" width="14.25" height="12.25" rx="0.625" stroke="#0E6651" stroke-width="0.75" />
                    ...
                    <div class="col-md-6 summaryInputsDiv">
                        <label for="client name">Start Year</label>
                        <input type="text" class="form-control NAData" :value="$props.data.flat_fixed_value ? $props.data.flat_fixed_start_year : 'N/A'" readonly>
                    </div>
            ...
            <form action="">
                <div class="row">
                    <div class="col-md-6 summaryInputsDiv">
                        ...
                        <input type="text" class="form-control" :value="`${$props.data.premium_charge}%`" readonly>
                    </div>
                    <div class="col-md-6 summaryInputsDiv">
                        <label for="client name">Same in All Years?</label>
                        <input v-if="$props.data.premium_same_in_all_years" type="text" class="form-control" value="Yes" readonly>
                            <p v-else class="Schedule-para" data-bs-toggle="modal" data-bs-target="#exampleModal">Scheduled 
                            <button type="button" class="schedule-icon-btn">
                                <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.375" y="0.375" width="14.25" height="12.25" rx="0.625" stroke="#0E6651" stroke-width="0.75" />
                    ...
                    <div class="col-md-6 summaryInputsDiv">
                        ...
                        <input type="text" class="form-control" :value="`${$props.data.loan_intrest_rate}%`" readonly>
                    </div>
                    <div class="col-md-6 summaryInputsDiv">
                        <label for="client name">Same in All Years?</label>
                        <input v-if="$props.data.loan_same_in_all_years" type="text" class="form-control" value="Yes" readonly>
                            <p v-else class="Schedule-para" data-bs-toggle="modal" data-bs-target="#exampleModal">Scheduled 
                            <button type="button" class="schedule-icon-btn">
                                <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.375" y="0.375" width="14.25" height="12.25" rx="0.625" stroke="#0E6651" stroke-width="0.75" />
                    ...
                    <div v-if="!$props.data.loan_intrest_charged_in_arrears" class="col-md-6 summaryInputsDiv">
                        ...
                        <input type="text" class="form-control NAData" :value="$props.data.performance_multiplier ? $props.data.loan_in_advanced_performance_multiplier : 'N/A'" readonly>
                    </div>
                    <div v-if="!$props.data.loan_intrest_charged_in_arrears" class="col-md-6 summaryInputsDiv">
                        <label for="client name">Same in All Years?</label>
                        <input v-if="$props.data.loan_in_advanced_same_in_all_years" type="text" class="form-control NAData"  :value="$props.data.performance_multiplier ? 'Yes' : 'N/A'" readonly>
                            <p v-else class="Schedule-para" data-bs-toggle="modal" data-bs-target="#exampleModal">Scheduled 
                            <button type="button" class="schedule-icon-btn">
                                <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.375" y="0.375" width="14.25" height="12.25" rx="0.625" stroke="#0E6651" stroke-width="0.75" />
                    ...
                    <div v-if="!$props.data.loan_intrest_charged_in_arrears" class="col-md-6 summaryInputsDiv">
                        ...
                        <input type="text" class="form-control NAData" :value="$props.data.flat_credit_bonus ? $props.data.in_advanced_flat_credit_bonus_fees : 'N/A'" readonly>
                    </div>
                    <div v-if="!$props.data.loan_intrest_charged_in_arrears" class="col-md-6 summaryInputsDiv">
                        <label for="client name">Same in All Years?</label>
                        <input v-if="$props.data.in_advanced_flat_credit_same_in_all_years" type="text" class="form-control NAData"  :value="$props.data.flat_credit_bonus ? 'Yes' : 'N/A'" readonly>
                            <p v-else class="Schedule-para" data-bs-toggle="modal" data-bs-target="#exampleModal">Scheduled 
                            <button type="button" class="schedule-icon-btn">
                                <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.375" y="0.375" width="14.25" height="12.25" rx="0.625" stroke="#0E6651" stroke-width="0.75" />
