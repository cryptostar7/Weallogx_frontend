     ...
     <div class="sidebar indexSidebar">
        <div class="position-sticky h-100 sidebar-inner extra">
          ...
          <ul class="nav flex-column flex-nowrap sidebar-nav">
              ...
              <a class="nav-link" href="#" data-bs-toggle="tooltip" data-bs-placement="right" title="Historical Simulations">
                <label class="cursor-pointer otherModecls">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M14.4205 12.3329C14.6028 12.4371 14.835 12.3741 14.9392 12.1908C15.0433 12.0074 14.9815 11.7763 14.8003 11.671L11.4962 9.7537V5.53929C11.4962 5.32879 11.3259 5.15735 11.1165 5.15735C10.906 5.15735 10.7356 5.32879 10.7356 5.53929V10.1953L14.4205 12.3329Z" fill="#3CB79A"/>
            ...
            <li class="nav-item">
            <router-link to="/tax-score-card" :class="`nav-link ${$route.path == '/tax-score-card' ? 'active' : ''} ${$route.path == '/tax-risk-analysis' ? 'active' : ''}`" data-bs-toggle="tooltip" data-bs-placement="right" title="Tax Scorecard">
                <label class="cursor-pointer otherModecls">
            ...
            <li class="nav-item">
              <a class="nav-link p-relative soon" href="#" data-bs-toggle="tooltip" data-bs-placement="right" title="Policy Comparison">
                <div class="coming-soon-icon-div"><img src="@/assets/images/icons/coming-soon.svg" class="img-fluid" alt="Coming Soon"></div>
                <label class="cursor-pointer otherModecls">
                  <svg width="25" height="16" viewBox="0 0 25 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M16.2964 14.4541C20.1335 14.4541 23.0947 11.5706 23.0947 8.19165C23.0947 4.81272 20.1335 1.9292 16.2964 1.9292C12.4592 1.9292 9.49805 4.81272 9.49805 8.19165C9.49805 11.5706 12.4592 14.4541 16.2964 14.4541ZM16.2964 15.7041C20.7414 15.7041 24.3447 12.3407 24.3447 8.19165C24.3447 4.04264 20.7414 0.679199 16.2964 0.679199C11.8514 0.679199 8.24805 4.04264 8.24805 8.19165C8.24805 12.3407 11.8514 15.7041 16.2964 15.7041Z" fill="#3CB79A"/>
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.57471 14.4541C12.4118 14.4541 15.373 11.5706 15.373 8.19165C15.373 4.81272 12.4118 1.9292 8.57471 1.9292C4.73757 1.9292 1.77637 4.81272 1.77637 8.19165C1.77637 11.5706 4.73757 14.4541 8.57471 14.4541ZM8.57471 15.7041C13.0197 15.7041 16.623 12.3407 16.623 8.19165C16.623 4.04264 13.0197 0.679199 8.57471 0.679199C4.12973 0.679199 0.526367 4.04264 0.526367 8.19165C0.526367 12.3407 4.12973 15.7041 8.57471 15.7041Z" fill="#3CB79A"/>
                  <path d="M16.1873 8.19165C16.1873 11.2745 14.5076 13.7737 12.4357 13.7737C10.3637 13.7737 8.68408 11.2745 8.68408 8.19165C8.68408 5.10878 10.3637 2.60962 12.4357 2.60962C14.5076 2.60962 16.1873 5.10878 16.1873 8.19165Z" fill="#3CB79A"/>
                  </svg>
              ...
              <a class="nav-link p-relative soon" href="#" data-bs-toggle="tooltip" data-bs-placement="right" title="Roth Conversion Alternative">
                ...
                <label class="cursor-pointer otherModecls">
                  <svg width="21" height="27" viewBox="0 0 21 27" fill="none">
                    ...
                    <mask id="mask0_1335_3" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="21" height="27">
                    <path d="M0.404297 0.877884H20.3855V26.3813H0.404297V0.877884Z" fill="white"/>
                    </mask>
                    <g mask="url(#mask0_1335_3)">
                    <path d="M0.404297 0.890045C3.38406 3.24602 7.41513 3.24602 10.3949 0.890045C13.3747 3.24602 17.4057 3.24602 20.3855 0.890045V10.0264C20.3855 17.3884 16.2584 23.697 10.3949 26.3472C4.53113 23.697 0.404297 17.3884 0.404297 10.0264V0.890045ZM1.77529 10.0289C1.77529 13.2882 2.65959 16.4299 4.33467 19.1126C5.14128 20.408 6.11491 21.5658 7.22758 22.5567C8.19873 23.4225 9.26366 24.1464 10.3971 24.7152C11.5306 24.1464 12.5933 23.4225 13.5667 22.5567C14.6796 21.5658 15.653 20.408 16.4596 19.1126C18.1324 16.4299 19.019 13.2882 19.019 10.0289V3.40815C17.8741 3.9021 16.6516 4.15691 15.3946 4.15691C13.6216 4.15691 11.9121 3.64756 10.3993 2.67939C8.88658 3.65026 7.17736 4.15691 5.40405 4.15691C4.14737 4.15691 2.92483 3.9021 1.77999 3.40815V10.0289H1.77529Z" fill="#3CB79A"/>
                    </g>
                    <path d="M15.3901 5.40447C16.2333 5.40447 17.0627 5.30233 17.8718 5.10021V10.0313C17.8718 13.0409 17.056 15.9384 15.5111 18.4138C14.7663 19.6092 13.8682 20.6774 12.8399 21.5934C12.0813 22.267 11.2608 22.851 10.3926 23.3328V4.09935C11.935 4.95538 13.6487 5.40447 15.3901 5.40447Z" fill="#3CB79A"/>
                    </g>
                    <defs>
                    <clipPath id="clip0_1335_3">
                    <rect width="20" height="25.5253" fill="white" transform="translate(0.402344 0.867889)"/>
                    </clipPath>
                    </defs>
                  </svg>
