<template lang="">
  ...
  <nav class="navbar navbar-expand-lg fixed-top report-top-navbar normal_navbar"  :style="{display:$store.state.app.presentation_mode ? 'none':'block'}">
    <div class="container-fluid">
      <router-link class="navbar-brand backToscenario" :to="historical && historical.simulation_id ? `/historical/simulation-details/${historical.simulation_id}?report=${$route.params.report}` : ''" >
        ...
        Back to Simulation</router-link>
  ...
  watch: {
    "$store.state.app.presentation_mode"(val) {
      ...
      if (val) {
        ...
        setTimeout(() => {
          this.pLoader = false;
          topTable = document.getElementById("historicalTableTabView");
          if(topTable){
