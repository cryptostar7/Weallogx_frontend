<template lang="">
  ...
  <nav class="navbar navbar-expand-lg fixed-top report-top-navbar normal_navbar"  :style="{display:$store.state.app.presentation_mode ? 'none':'block'}">
    <div class="container-fluid">
      <router-link class="navbar-brand backToscenario" :to="comparative && comparative.scenerio_id ? `/scenario-details/${comparative.scenerio_id}?report=${$route.params.report}` : ''" >
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 flex-row justify-content-center">
          ...
          <li class="nav-item text-center">
            <a :href="`${$apiUrl()}/report/generate-pdf/${$route.params.report}`" class="btn my-2 my-lg-0 navbar-nav-scroll dwnldReportBtn" title="Download Report">
