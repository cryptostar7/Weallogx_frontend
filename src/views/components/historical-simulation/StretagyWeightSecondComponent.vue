<template lang="">
  ...
  >
    <div class="strategyWeight d-flex">
      <div id="strategyWeight1" class="mainResizeDiv position-relative">#1</div>
  ...
  watch: {
    "$props.ratio"(e) {
      if (e) {
        ...
        // set range width
        document.getElementById("strategyWeight1").style.width = `${e.weight_1}%`;
        document.getElementById("strategyWeight2").style.width = `${e.weight_2}%`;
        document.getElementById("strategyWeight3").style.width = `${e.weight_3}%`;
