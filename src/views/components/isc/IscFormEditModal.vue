  ...
  methods: {
    ...
    validateStrategyForm: function (tab) {
      ...
      if((Number(this.startYear) < item.max_year)){
        valid = false;
        this.$toast.error(`The earliest year for the selected index is ${this.startYear}. Please change the index selection or update your start year.`);
      }
