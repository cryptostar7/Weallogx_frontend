    ...
    <div class="container-fluid px-0">
        ...
        <div class="col-sm-7">
          <p>
            ...
            <span class="tooltips"
              ...
              <span class="w-225"
                >Represents the net ending balance after all fees</span
              >
            </span>
          </p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <p :class="[
                'text-end',
                $props.summary.total_negative_years < 0 ? 'highlighted' : ''
            ]">
      ...
      <div class="row">
        <div class="col-sm-8">
          <p class="p-relative">
            <button
              class="btn table-chevron-btn green collapsed"
      ...
      <div class="row collapse" id="aror3">
        ...
        <div class="col-sm-4">
          <p class="table-green-clr text-end">
            {{
