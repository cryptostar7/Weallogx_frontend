      ...
      <div class="index-strategy-content-inner-div withBoxShadow">
            ...
            <div class="col-md-6 col-lg-3 inp-mar-top">
              ...
              <div class="index-strategy-each-inputs dollar">
                ...
                <input
                  ...
                  @keyup="(e) => (beginningBalance = e.target.value)"
                  max="9999999999"
                />
              </div>
            </div>
            <div class="col-md-6 col-lg-3 inp-mar-top">
              ...
              <div class="select-menu">
                <div class="select-btn">
                  <span class="sBtn-text">{{ vehicleType }}</span>
                  <i
                    ><img
            ...
            <div class="col-md-6 col-lg-3 inp-mar-top">
              <label for="beginningBalance"
                ...
                <span>
                  ...
                  <span
                    >Choose your tax rate. This will remain constant between
                    each index strategy.</span
                  >
                </span>
              </label>
        ...
        <div class="strategy-parameter-main-div">
            ...
            <div class="multi-radio-main-div">
              ...
              >
                <input
                  ...
                  id="3"
                />
                <label class="each-radio-label" id="historicalTopCheckBoxDiv3"
                  >3</label
                >
              </div>
            </div>
          ...
          >
            ...
            <div :class="`strategy-allocated-div ${tabs.tab2 ? 'active' : ''}`">
              <input
                type="text"
                class="form-control allocation-input"
            ...
            <div :class="`strategy-allocated-div ${tabs.tab3 ? 'active' : ''}`">
              <input
                type="text"
                class="form-control allocation-input"
          ...
          <index-strategy-form :currentTab="1" :activeTab="activeTab" />
          <index-strategy-form :currentTab="2" :activeTab="activeTab" />
          <index-strategy-form :currentTab="3" :activeTab="activeTab" />
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    submitHandler: function () {
      ...
      if (this.tabs.tab2) {
        formData.strategies[1] = this.getStrategyObject(1);
      }
      ...
      localStorage.setItem("isc_calculate_inputs", formData);
  ...
  mounted() {
    ...
    const inputs = document.querySelectorAll(".onlyPositiveNum");
