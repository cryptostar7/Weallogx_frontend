      ...
      <div class="container-fluid">
        <div class="d-flex justify-content-between flex-gap-12">
                ...
                <div class="distributionCard1 equalDistCard1 position-relative w-100">
                  <div class="d-flex justify-content-between">
                    <div class="distrbnCard1paras">
                      <p>Longevity</p>
                      <p>{{data[0].categories.most_recent.type}}</p>
                    </div>
                    <div class="d-flex">
                  ...
                  <div class="d-flex justify-content-between mt-1">
                    <div class="compGraphtopPara bgChangerComGraph1">
                      <p>Longevity</p>
                      <p>{{data[0].categories.most_recent.longevity_years}}</p>
                    </div>
                    <div class="compGraphtopPara bgChangerComGraph1">
                      <p class="text-end">Cumulative Income</p>
                      <p class="text-end">{{$numFormatWithDollar(data[0].categories.most_recent.cummulative_income)}}</p>
                    </div>
                  </div>
                  ...
                  <div class="d-flex">
                    <div class="compGraphtopParaTwo">
                      <p>Rate of Return</p>
                      <p>{{data[0].categories.most_recent.ror}}</p>
                    </div>
                    <div class="compGraphtopParaTwo cardParLeftMar">
                      <p>IRR</p>
                      <p>{{data[0].categories.most_recent.irr}}</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="tab-pane fade h-100" id="card-worst" role="tabpanel" aria-labelledby="card-mostRecent-tab">
                <div class="distributionCard1 equalDistCard1 position-relative w-100">
                  <div class="d-flex justify-content-between">
                    <div class="distrbnCard1paras">
                      <p>Longevity</p>
                      <p>{{data[0].categories.worst.type}}</p>
                    </div>
                    <div class="d-flex">
                      <div class="button-cover2">
                        <div class="radioBtnDiv greenRadioSwtch r2" id="button-2">
                  ...
                  <div class="d-flex justify-content-between mt-1">
                    <div class="compGraphtopPara bgChangerComGraph1">
                      <p>Longevity</p>
                      <p>{{data[0].categories.worst.longevity_years}}</p>
                    </div>
                    <div class="compGraphtopPara bgChangerComGraph1">
                      <p class="text-end">Cumulative Income</p>
                      <p class="text-end">{{$numFormatWithDollar(data[0].categories.worst.cummulative_income)}}</p>
                    </div>
                  </div>
                  <div class="compGraphSmallBdr compGraphSmallBdrClr1 pt-1 mb-two">
                    <p></p>
                  ...
                  <div class="d-flex">
                    <div class="compGraphtopParaTwo">
                      <p>Rate of Return</p>
                      <p>{{data[0].categories.worst.ror}}</p>
                    </div>
                    <div class="compGraphtopParaTwo cardParLeftMar">
                      <p>IRR</p>
                      <p>{{data[0].categories.worst.irr}}</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="tab-pane fade h-100" id="card-median" role="tabpanel" aria-labelledby="card-mos tRecent-tab">
                <div class="distributionCard1 equalDistCard1 position-relative w-100">
                  <div class="d-flex justify-content-between">
                    <div class="distrbnCard1paras">
                      <p>Longevity</p>
                      <p>{{data[0].categories.median.type}}</p>
                    </div>
                    <div class="d-flex">
                      <div class="button-cover2">
                        <div class="radioBtnDiv greenRadioSwtch r2" id="button-2">
                  ...
                  <div class="d-flex justify-content-between mt-1">
                    <div class="compGraphtopPara bgChangerComGraph1">
                      <p>Longevity</p>
                      <p>{{data[0].categories.median.longevity_years}}</p>
                    </div>
                    <div class="compGraphtopPara bgChangerComGraph1">
                      <p class="text-end">Cumulative Income</p>
                      <p class="text-end">{{$numFormatWithDollar(data[0].categories.median.cummulative_income)}}</p>
                    </div>
                  </div>
                  <div class="compGraphSmallBdr compGraphSmallBdrClr1 pt-1 mb-two">
                    <p></p>
                  ...
                  <div class="d-flex">
                    <div class="compGraphtopParaTwo">
                      <p>Rate of Return</p>
                      <p>{{data[0].categories.median.ror}}</p>
                    </div>
                    <div class="compGraphtopParaTwo cardParLeftMar">
                      <p>IRR</p>
                      <p>{{data[0].categories.median.irr}}</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="tab-pane fade h-100" id="card-best" role="tabpanel" aria-labelledby="card-mostRecent-tab">
                <div class="distributionCard1 equalDistCard1 position-relative w-100">
                  <div class="d-flex justify-content-between">
                    <div class="distrbnCard1paras">
                      <p>Longevity</p>
                      <p>{{data[0].categories.best.type}}</p>
                    </div>
                    <div class="d-flex">
                      <div class="button-cover2">
                        <div class="radioBtnDiv greenRadioSwtch r2" id="button-2">
                  ...
                  <div class="d-flex justify-content-between mt-1">
                    <div class="compGraphtopPara bgChangerComGraph1">
                      <p>Longevity</p>
                      <p>{{data[0].categories.best.longevity_years}}</p>
                    </div>
                    <div class="compGraphtopPara bgChangerComGraph1">
                      <p class="text-end">Cumulative Income</p>
                      <p class="text-end">{{data[0].categories.best.cummulative_income}}</p>
                    </div>
                  </div>
                  <div class="compGraphSmallBdr compGraphSmallBdrClr1 pt-1 mb-two">
                    <p></p>
                  ...
                  <div class="d-flex">
                    <div class="compGraphtopParaTwo">
                      <p>Rate of Return</p>
                      <p>{{data[0].categories.best.ror}}</p>
                    </div>
                    <div class="compGraphtopParaTwo cardParLeftMar">
                      <p>IRR</p>
                      <p>{{data[0].categories.best.irr}}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="flex-1" v-for="(card, index) in cards" :key="card.id">
            <div :class="`distributionCard1 equalDistCard${2+index} position-relative w-100`">
              <div class="d-flex justify-content-between">
                <div class="distrbnCard1paras">
                  <p>Longevity</p>
