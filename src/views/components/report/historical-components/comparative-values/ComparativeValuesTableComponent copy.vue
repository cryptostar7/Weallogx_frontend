...
export default {
  ...
  methods: {
    ...
    filterData: function (data, strategy_average, type) {
      let finalData = {
        strategy_average: "",
        strategy_cagr: "",
        irr: "",
      ...
      if (data.chart_output) {
        ...
        if (list.length) {
          ...
          finalData.strategy_average = strategy_average;
        ...
        data: {
          ...
          categories: {
            most_recent: this.filterData(
              ...
              this.historical.most_recent.result.stratgy_average,
              "TSA - Most Recent"
            ),
            worst: this.filterData(
              this.historical.min.result,
              this.historical.min.result.stratgy_average,
              "TSA - Worst"
            ),
            median: this.filterData(
              this.historical.median.result,
              this.historical.median.result.stratgy_average,
              "TSA - Median"
            ),
            best: this.filterData(
              this.historical.max.result,
              this.historical.max.result.stratgy_average,
              "TSA - Best"
            ),
          },
        },
