                    ...
                    <div class="col-4 col-md-2 ps-0 pe-1">
                      <div class="commonTableMainTopDiv4">
                        <div class="reportTablesDiv reportTablesDiv8">
                          ...
                          <table class="table sticky-header-h tableCommonForDisable  mt-1 tableCommonHide">
                            <thead class="heading-tr">
                              <tr>
                              <th>Distributions</th>
                              <th>Net Balance</th>
                            ...
                            <tbody>
                              <tr v-for="(item, index) in data[0].list" :key="index">
                                <td data-label="acount"> <span class="td-bold">{{ $numFormatWithDollar(item.distributions) }}</span></td>
                                    ...
                                    <table class="table sticky-header-h tableCommonForDisable  mt-1 tableCommonHide">
                                      ...
                                      <tbody>
                                        <tr v-for="(item, index) in data[header.id].list" :key="index">
                                          <td data-labe.l="acount"><span v-if="$numFormatWithDollar(item.distributions)" :class="`td-bold`">{{ $numFormatWithDollar(item.distributions) }}</span></td>
                                          <td data-label="blank">{{ $numFormatWithDollar(item.net_balance)}}</td>
                                        </tr>
                                      </tbody>
                                    </table>
