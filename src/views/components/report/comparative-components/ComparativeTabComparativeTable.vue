        ...
        <div class="ComparativeTableMainDiv active rightDivTop1">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="radioBtnDiv r2" id="button-2">
                    <input id="rightCheckBox1" type="checkbox" class="checkbox2 rightCheckBox1" :checked="status"
                    rightCheckAttr="1" />
                    <div class="knobs2"></div>
                    <div class="layer2"></div>
                </div>
                </div>
                <label for="rightCheckBox1" class="rghtTopHeadcommon" @click="collapseSection(0)">Comparative Table</label>
            </div>
            ...
            <div>
            <div
                class="commonCollapse comparativeLessDiv comparativeLessDiv2 collapseDiv1 position-relative tableDivHeight1">
                ...
                <div class="d-flex justify-content-center mt-2">
                    ...
                    <div class="active" data-bs-toggle="pill" data-bs-target="#v-pills-distribution"
                        type="button" role="tab" aria-controls="v-pills-distribution" aria-selected="true">
                        Distribution
                    </div>
                    <div data-bs-toggle="pill" data-bs-target="#v-pills-rate-of-return" type="button"
                        role="tab" aria-controls="v-pills-rate-of-return" aria-selected="false">Rate of Return
                    </div>
                    </div>
                </div>
                <div class="tab-content">
                    ...
                    <div class="d-flex justify-content-center mt-2">
                        ...
                        <div id="v-pills-longevity-tab" data-bs-toggle="pill"
                            data-bs-target="#v-pills-longevity" type="button" role="tab"
                            aria-controls="v-pills-longevity" aria-selected="true">
                            Longevity
                        </div>
                            ...
                            <div class="reportTablesDiv reportTablesDiv4">
                                ...
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <input type="checkbox" class="checkbox2 commonRadioBtn1"
                                            checked="true" hideattr="1" onclick="tableDivHide(this, event)">
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                        </div>
                                        <div class="d-flex align-items-center">
                            ...
                            <div class="reportTablesDiv reportTablesDiv5">
                                ...
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <div class="radioBtnDiv r2 voiletRadioSwtch" id="button-2">
                                        <input type="checkbox" class="checkbox2 commonRadioBtn1"
                                            checked="true" hideattr="2" onclick="tableDivHide(this, event)">
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                        </div>
                                        <div class="d-flex align-items-center">
                            ...
                            <div class="reportTablesDiv reportTablesDiv6">
                                ...
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <input type="checkbox" class="checkbox2 commonRadioBtn1"
                                            checked="true" hideattr="3" onclick="tableDivHide(this, event)">
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                        </div>
                                        <div class="d-flex align-items-center">
                    ...
                    <div class="row">
                        ...
                        <div class="reportTablesDiv reportTablesDiv1 SummaryTableDiv1">
                            ...
                            <thead>
                                ...
                                <th class="heading-tr shiftBorder"
                                style="border-radius:6px;vertical-align: middle;">Deposits</th>
                            </thead>
                            <tbody>
                                <tr>
