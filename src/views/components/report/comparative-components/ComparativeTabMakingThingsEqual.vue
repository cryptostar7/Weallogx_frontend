<template lang="">
  ...
  >
    <div class="fill" data-class="empty-fill" draggable="true" data-fill="3">
      ...
      >
        <div
          :class="`ComparativeTableMainDiv rightDivTop3 ${
        ...
        >
          ...
          >
            <div class="d-flex align-items-center">
              ...
              <label for="rightCheckBox3" class="rghtTopHeadcommon"
                >Making Things Equal<span class="ms-3 equalThingTabTxt"
                  >The {{ currentTab }} required to match the LIRP.</span
                ></label
              >
            </div>
          ...
          <div
            class="collapseDivMain collapseDiv3"
              ...
              <div class="d-flex justify-content-center tab-menu">
                ...
                >
                  <div
                    ...
                    @click="() => (currentTab = 'distributions amounts')"
                    data-bs-toggle="pill"
                  ...
                  <div
                    ...
                    @click="() => (currentTab = 'rate of return')"
                    data-bs-toggle="pill"
              ...
              <div class="tab-content" id="pills-tabContent">
                ...
                >
                  <div class="container-fluid cards-area">
                    <div class="d-flex flex-gap-12 justify-content-between">
                      <div
                        v-for="(item, index) in data.distribution"
                        :key="index"
                        :class="`mt-3 flex-1 ${
                      ...
                      >
                        <div
                          :class="`distributionCard1 making equalDistCard${
                            1 + index
                          } position-relative w-100 ${
                            cards.distributions[index].active ? '' : 'inactive'
                          }`"
                        >
                          <div
                            ...
                            <div class="d-flex">
                              <div class="button-cover2">
                                ...
                                >
                                  <input
                                    type="checkbox"
                                    :class="`checkbox2 commonRadioBtn1 groupBaCard${
                                      1 + index
                                    }`"
                                    :checked="cards.distributions[index].active"
                                    @change="
                                      () =>
                                        (cards.distributions[index].active =
                                          !cards.distributions[index].active)
                                    "
                                  />
                                  <div class="knobs2"></div>
                              ...
                              <a
                                :class="`ms-2 deleteButtonAncor deleteBtn${
                                  1 + index
                                } ${index ? '' : 'd-none'} ${
                          ...
                          <p :class="`cardRadioSwtchpara${1 + index}`">
                            {{ cv_name[index] }}
                          </p>
                          <div class="mt-2 d-flex">
                            <div
                              :class="`CardProgressBar lightProgress${
                                1 + index
                              } groupBoxProgressCommon${1 + index}  ${
                                cards.distributions[index].active
                                  ? ''
                                  : 'boxProgress'
                              }`"
                            ...
                            <p
                              :class="`mt-1 ms-2 CardProgressnym carValue1 makeEqualPara${
                                1 + index
                              }`"
                              v-if="!index"
                            >
                            ...
                            <div
                              class="d-flex flex-1 w-100 justify-content-between"
                            >
                              <div class="position-up" v-if="index">
                                <p class="ms-2 cardProjectTag">Longevity</p>
                                <p
                                  :class="`ms-2 CardProgressnym cardRadioSwtchpara makeEqualPara${
                                    1 + index
                                  }`"
                                >
                                  {{ $numFormatWithDollar(item.longevity) }}
                                </p>
                              </div>
                              <div class="position-up" v-if="index">
                                <p class="cardProjectTag textGap">
                                  Ending Value
                                </p>
                                <p
                                  :class="`CardProgressnym textGap cardRadioSwtchpara makeEqualPara${
                                    1 + index
                                  }`"
                                >
                                  {{ $numFormatWithDollar(item.ending_value) }}
                                </p>
                              </div>
                              <div class="position-up" v-if="index">
                                <p class="cardProjectTag textGap">
                                ...
                                >
                                  {{ $numFormatWithDollar(item.death_benefit) }}
                                </p>
                              </div>
                            </div>
                          </div>
                          <add-note-input-component
                            reportType="comperative"
                            noteType="comperative_distribution"
                            :cvType="1 + index"
                  ...
                  <div class="container-fluid">
                    <div class="mainProgrssBarDiv graph-area">
                      <div
                        class="progressAbsltCls makeThinkEqualDiv p-relative"
                      >
                        <div
                          class="lines-div d-flex flex-column justify-content-between h-100"
                        >
                          <div
                            v-for="(item, index) in 6"
                            :key="index"
                            :class="`d-flex mainProgBrdrDivs ${
                              item > 5 ? 'm-0 p-0' : ''
                            }`"
                          >
                        ...
                        <div
                          class="progressAllBarsDivMain makeThinkEqualDivInner"
                        >
                          <div class="progressBarEachDivMain">
                            <div
                              :class="`d-flex groupedFourBars1 ${
                                graphs.distributions.longevity
                                  ? ''
                                  : 'disableGroupedBar'
                              }`"
                            >
                              <div
                                v-for="(item, index) in data.distribution
                                  .length"
                                :key="index"
                                :class="`progressBarEachDiv progressBarEachHeight${
                                  1 + index
                              ...
                              >
                                <div
                                  :class="`CardProgressBig CardProgressBig${
                                    1 + index
                                  } thingEqualPercent${1 + index}`"
                                  :style="{
                                    height: `${
                                      (Number(
                                        index
                                          ? data.distribution[index].longevity
                                ...
                                ></div>
                                <div
                                  :class="`position-absolute progressBarbtmNum progressBarOvrwrt${
                                    1 + index
                                  }`"
                                >
                                  $<span
                                    :class="`thingEqualProg${1 + index}`"
                                    >{{
                                      $numFormat(
                                        index
                                          ? data.distribution[index].longevity
                          ...
                          <div class="progressBarEachDivMain">
                            <div
                              :class="`d-flex groupedFourBars2 ${
                                graphs.distributions.ending_value
                                  ? ''
                                  : 'disableGroupedBar'
                              }`"
                            >
                          ...
                          <div class="progressBarEachDivMain">
                            <div
                              :class="`d-flex groupedFourBars3 ${
                                graphs.distributions.death_benefit
                                  ? ''
                                  : 'disableGroupedBar'
                              }`"
                            >
                      ...
                      <div
                        :class="`progressAllBarsDivMain barItems${
                          data.distribution.length - deletedItems.length
                        }`"
                      >
                ...
                >
                  <div class="container-fluid cards-area">
                    <div class="d-flex flex-gap-12 justify-content-between">
                      <div
                        v-for="(item, index) in data.rate_of_returns"
                        :key="index"
                        :class="`mt-3 flex-1 ${
                          deletedItems.includes(index) ? 'd-none' : ''
                        }`"
                      >
                        <div
                          :class="`distributionCard1 making equalDistCard${
                            ...
                            cards.rate_of_returns[index].active
                              ? ''
                              : 'inactive'
                          }`"
                        >
                          ...
                          <div class="mt-2 d-flex">
                            ...
                            >
                              <div
                                :class="`CardProgress darkProgress${1 + index}`"
                              ></div>
                              <p class="lineUnderBars"></p>
                            </div>
                            <p
                            ...
                            >
                              <div class="position-up" v-if="index">
                                ...
                                >
                                  {{ Number(item.longevity).toFixed(2) }}%
                                </p>
                              </div>
                              <div class="position-up" v-if="index">
                                <p class="cardProjectTag textGap">
                                ...
                                >
                                  {{ Number(item.ending_value).toFixed(2) }}%
                                </p>
                              </div>
                              <div class="position-up" v-if="index">
                                <p class="cardProjectTag textGap">
                                ...
                                >
                                  {{ Number(item.death_benefit).toFixed(2) }}%
                                </p>
                              </div>
                            </div>
                          </div>
                          <add-note-input-component
                            reportType="comperative"
                            noteType="comperative_rate_of_return"
                            :cvType="1 + index"
                            :noteId="
                              ror_notes[index] ? ror_notes[index].id : null
                            "
                            :noteText="
                              ror_notes[index] ? ror_notes[index].text : null
                            "
                          />
                        </div>
                      </div>
                      ...
                      >
                        ...
                        >
                          <div class="progressBarEachDivMain">
                            <div
                              :class="`d-flex groupedFourBars1 ${
                                graphs.rate_of_returns.longevity
                                  ? ''
                                  : 'disableGroupedBar'
                              }`"
                            >
                                ...
                                <div
                                  ...
                                  :style="{
                                    height: `${
                                      (Number(
                                        index
                                          ? data.rate_of_returns[index]
                                              .longevity
                                          : data.rate_of_returns[0].ror
                                      ) *
                                        100) /
                                      maxRor
                                    }%`,
                          ...
                          <div class="progressBarEachDivMain">
                            <div
                              :class="`d-flex groupedFourBars2 ${
                                graphs.rate_of_returns.ending_value
                                  ? ''
                                  : 'disableGroupedBar'
                              }`"
                            >
                          ...
                          <div class="progressBarEachDivMain">
                            <div
                              :class="`d-flex groupedFourBars3 ${
                                graphs.rate_of_returns.death_benefit
                                  ? ''
                                  : 'disableGroupedBar'
                              }`"
                            >
...
export default {
  ...
  methods: {
    ...
    setLongevity: function () {
      this.data.distribution[1].distributions =
        this.longevity.cv_1.comparison.chart_output.distributions.filter(
          (v) => v
        )[0];
    ...
    setEndingValue: function () {
      this.data.distribution[2].distributions =
        this.ending_value.cv_1.comparison.chart_output.distributions.filter(
          (v) => v
        )[0];
      this.data.rate_of_returns[2].ror = this.ending_value.cv_1.comparison.ror;
    },
    setDeathBenefit: function () {
      this.data.distribution[3].distributions =
        this.death_benefit.cv_1.comparison.chart_output.distributions.filter(
          (v) => v
        )[0];
    ...
    if (this.comparative && Object.keys(this.comparative).length) {
      if (this.comparative.cv_1) {
        this.data.distribution[0].distributions =
          this.comparative.lirp_data.making_things_equal_distribution;
        ...
        this.data.rate_of_returns[1].death_benefit =
          this.comparative.cv_1.match_rates_of_return.death_benefit;
        this.data.rate_of_returns[1].ending_value =
          this.comparative.cv_1.match_rates_of_return.surrender_value;
      }
      ...
      if (Object.values(this.comparative.cv_2).length) {
        ...
        this.data.rate_of_returns[2].death_benefit =
          this.comparative.cv_2.match_rates_of_return.death_benefit;
        this.data.rate_of_returns[2].ending_value =
          this.comparative.cv_2.match_rates_of_return.surrender_value;
      }
      ...
      if (Object.values(this.comparative.cv_3).length) {
        ...
        this.data.rate_of_returns[3].death_benefit =
          this.comparative.cv_3.match_rates_of_return.death_benefit;
        this.data.rate_of_returns[3].ending_value =
  ...
  computed: {
    cards() {
      return this.$store.state.data.reportTabs.active_cards.cmp_making_things
        .cards;
    },
    graphs() {
      return this.$store.state.data.reportTabs.active_cards.cmp_making_things
