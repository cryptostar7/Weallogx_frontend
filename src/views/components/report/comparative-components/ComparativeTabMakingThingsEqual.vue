            ...
            <div class="ComparativeTableMainDiv active rightDivTop3 ">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="radioBtnDiv r2" id="button-2">
                        <input id="rightCheckBox3" type="checkbox" class="checkbox2 rightCheckBox3"
                        rightCheckAttr="3" onchange="rightCheckbox(this,event)" checked />
                ...
                <div class="px-3 pt-3 pb-2">
                    ...
                    <div class="nav SwtchBtnRprtBldr nav-pills" role="tablist" aria-orientation="vertical">
                        ...
                        <div id="v-pills-rateOfReturn-tab" data-bs-toggle="pill"
                        data-bs-target="#v-pills-rateOfReturn" type="button" role="tab"
                        aria-controls="v-pills-rateOfReturn" aria-selected="false">Rate of Return
                        </div>
                    </div>
                    </div>
                            ...
                            <div class="distributionCard1 equalDistCard1 position-relative w-100">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="radioBtnDiv greenRadioSwtch r2" id="button-2">
                                        <input type="checkbox" class="checkbox2 commonRadioBtn1 groupBaCard1"
                                        checked groupProgBar="1" onchange="groupProgressbar(this,event)" />
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                    </div>
                                    </div>
                            ...
                            <div class="distributionCard1 equalDistCard2 position-relative w-100">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="radioBtnDiv r2 blueRadioSwtch" id="button-2">
                                        <input type="checkbox" class="checkbox2 commonRadioBtn1 groupBaCard2"
                                        checked groupProgBar="2" onchange="groupProgressbar(this,event)" />
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                    </div>
                                    </div>
                            ...
                            <div class="distributionCard1 equalDistCard3 position-relative w-100">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="radioBtnDiv r2 voiletRadioSwtch" id="button-2">
                                        <input type="checkbox" class="checkbox2 commonRadioBtn1 groupBaCard3"
                                        checked groupProgBar="3" onchange="groupProgressbar(this,event)" />
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                    </div>
                                    </div>
                            ...
                            <div class="distributionCard1 equalDistCard4 position-relative w-100">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="radioBtnDiv r2 redRadioSwtch" id="button-2">
                                        <input type="checkbox" class="checkbox2 commonRadioBtn1 groupBaCard4"
                                        checked groupProgBar="4" onchange="groupProgressbar(this,event)" />
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                    </div>
                                    </div>
                            ...
                            <div class="progressAllBarsDivMain">
                                ...
                                <div class="progressBarEachBtm">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="radioBtnDiv r2 " id="button-2">
                                            <input type="checkbox"
                                            class="checkbox2 longevityMatchJSCls1 commonRadioBtn1" checked
                                ...
                                <div class="d-flex groupedFourBars2">
                                    <div
                                    class="progressBarEachDiv  progressBarEachHeight5 groupedSecBarsSigleClr1">
                                    ...
                                    <div
                                    class="progressBarEachDiv  progressBarEachHeight6 groupedSecBarsSigleClr2">
                                    ...
                                    <div
                                    class="progressBarEachDiv  progressBarEachHeight7 groupedSecBarsSigleClr3">
                                    ...
                                    <div
                                    class="progressBarEachDiv  progressBarEachHeight8 groupedSecBarsSigleClr4">
                                ...
                                <div class="progressBarEachBtm">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="radioBtnDiv r2" id="button-2">
                                            <input type="checkbox"
                                            class="checkbox2 commonRadioBtn1 longevityMatchJSCls2" checked
                                            longevityMatchAttr="2" onchange="longevityMatch(this, event)" />
                                            <div class="knobs2"></div>
                                            <div class="layer2"></div>
                                        </div>
                                        </div>
                                ...
                                <div class="d-flex groupedFourBars3">
                                    <div
                                    class="progressBarEachDiv  progressBarEachHeight9 groupedThirdBarsSigleClr1">
                                    ...
                                    <div
                                    class="progressBarEachDiv progressBarEachHeight10 groupedThirdBarsSigleClr2">
                                    ...
                                    <div
                                    class="progressBarEachDiv progressBarEachHeight11 groupedThirdBarsSigleClr3">
                                    ...
                                    <div
                                    class="progressBarEachDiv progressBarEachHeight12 groupedThirdBarsSigleClr4">
                                ...
                                <div class="progressBarEachBtm">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="radioBtnDiv r2" id="button-2">
                                            <input type="checkbox"
                                            class="checkbox2 commonRadioBtn1 longevityMatchJSCls3" checked
                                            longevityMatchAttr="3" onchange="longevityMatch(this, event)" />
                                            <div class="knobs2"></div>
                                            <div class="layer2"></div>
                                        </div>
                                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="distributionCard1 equalDistCard1 position-relative w-100">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="radioBtnDiv greenRadioSwtch r2" id="button-2">
                                        <input type="checkbox"
                                        class="checkbox2 commonRadioBtn1 commonRadioBtn1 groupBaCard5" checked
                                        groupProgBar="5" onchange="groupProgressbar(this,event)" />
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                    </div>
                                    </div>
                            ...
                            <div class="distributionCard1 equalDistCard2 position-relative w-100">
                                ...
                                <div class="d-flex">
                                    <div class="button-cover2">
                                    <div class="radioBtnDiv r2 blueRadioSwtch" id="button-2">
                                        <input type="checkbox" class="checkbox2 commonRadioBtn1 groupBaCard6"
                                        checked groupProgBar="6" onchange="groupProgressbar(this,event)" />
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                    </div>
                                    </div>
                            ...
                            <div class="distributionCard1 equalDistCard3 position-relative w-100">
                                ...
                                <div class="d-flex">
                                    <div class="button-cover2">
                                    <div class="radioBtnDiv r2 voiletRadioSwtch" id="button-2">
                                        <input type="checkbox" class="checkbox2 commonRadioBtn1 groupBaCard7"
                                        checked groupProgBar="7" onchange="groupProgressbar(this,event)" />
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                    </div>
                                    </div>
                            ...
                            <div class="distributionCard1 equalDistCard4 position-relative w-100">
                                ...
                                <div class="d-flex">
                                    <div class="button-cover2">
                                    <div class="radioBtnDiv r2 redRadioSwtch" id="button-2">
                                        <input type="checkbox" class="checkbox2 commonRadioBtn1 groupBaCard8"
                                        checked groupProgBar="8" onchange="groupProgressbar(this,event)" />
                                        <div class="knobs2"></div>
                                        <div class="layer2"></div>
                                    </div>
                                    </div>
                            ...
                            <div class="progressAllBarsDivMain">
                                ...
                                <div class="progressBarEachBtm">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="radioBtnDiv r2 " id="button-2">
                                            <input type="checkbox"
                                            class="checkbox2 longevityMatchJSCls4 commonRadioBtn1" checked
                                ...
                                <div class="d-flex groupedFourBars2">
                                    <div
                                    class="progressBarEachDiv  progressBarEachHeight25 groupedSecBarsSigleClr5">
                                    ...
                                    <div
                                    class="progressBarEachDiv  progressBarEachHeight26 groupedSecBarsSigleClr6">
                                    ...
                                    <div
                                    class="progressBarEachDiv  progressBarEachHeight27 groupedSecBarsSigleClr7">
                                    ...
                                    <div
                                    class="progressBarEachDiv  progressBarEachHeight28 groupedSecBarsSigleClr8">
                                ...
                                <div class="progressBarEachBtm">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="radioBtnDiv r2" id="button-2">
                                            <input type="checkbox"
                                            class="checkbox2 longevityMatchJSCls5 commonRadioBtn1" checked
                                ...
                                <div class="d-flex groupedFourBars3">
                                    <div
                                    class="progressBarEachDiv  progressBarEachHeight29 groupedThirdBarsSigleClr5">
                                    ...
                                    <div
                                    class="progressBarEachDiv progressBarEachHeight210 groupedThirdBarsSigleClr6">
                                    ...
                                    <div
                                    class="progressBarEachDiv progressBarEachHeight211 groupedThirdBarsSigleClr7">
                                    ...
                                    <div
                                    class="progressBarEachDiv progressBarEachHeight212 groupedThirdBarsSigleClr8">
                                ...
                                <div class="progressBarEachBtm">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="radioBtnDiv r2" id="button-2">
                                            <input type="checkbox"
                                            class="checkbox2 longevityMatchJSCls6 commonRadioBtn1" checked
