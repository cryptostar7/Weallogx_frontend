        ...
        <div class="ComparativeTableMainDiv active rightDivTop5">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="radioBtnDiv r2" id="button-2">
                    <input id="rightCheckBox5" type="checkbox" checked class="checkbox2 rightCheckBox5"
                    rightCheckAttr="5" onchange="rightCheckbox(this,event)" />
            ...
            <div class="px-3 pt-3 pb-2">
                    ...
                    <div class="distributionCard1 equalDistCard1 position-relative w-100">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="radioBtnDiv greenRadioSwtch r2" id="button-2">
                                <input type="checkbox" class="checkbox2 commonRadioBtn1 lagecyBigBaCard1"
                                checked lagecyBigProgBar="1" onchange="lagecyBigProgressbar(this,event)" />
                                <div class="knobs2"></div>
                                <div class="layer2"></div>
                            </div>
                            </div>
                    ...
                    <div class="distributionCard1 equalDistCard2 position-relative w-100">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="radioBtnDiv r2 blueRadioSwtch" id="button-2">
                                <input type="checkbox" class="checkbox2 commonRadioBtn1 lagecyBigBaCard2"
                                checked lagecyBigProgBar="2" onchange="lagecyBigProgressbar(this,event)" />
                                <div class="knobs2"></div>
                                <div class="layer2"></div>
                            </div>
                            </div>
                    ...
                    <div class="distributionCard1 equalDistCard3 position-relative w-100">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="radioBtnDiv r2 voiletRadioSwtch" id="button-2">
                                <input type="checkbox" class="checkbox2 commonRadioBtn1 lagecyBigBaCard3"
                                checked lagecyBigProgBar="3" onchange="lagecyBigProgressbar(this,event)" />
                                <div class="knobs2"></div>
                                <div class="layer2"></div>
                            </div>
                            </div>
                    ...
                    <div class="distributionCard1 equalDistCard4 position-relative w-100">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="radioBtnDiv r2 redRadioSwtch" id="button-2">
                                <input type="checkbox" class="checkbox2 commonRadioBtn1 lagecyBigBaCard4"
                                checked lagecyBigProgBar="4" onchange="lagecyBigProgressbar(this,event)" />
                                <div class="knobs2"></div>
                                <div class="layer2"></div>
                            </div>
                            </div>
                ...
                <div class="CompMainProgrssBarDiv">
                    ...
                    <div class="progressAllBarsDivMain">
                        ...
                        <div
                            class="cumulativeValuesProgrees progBarSecEachDiv12 cumulativeProgCommon12 bigBarsLagecyJsCls4">
