        ...
        <div class="ComparativeTableMainDiv active rightDivTop4">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="radioBtnDiv r2" id="button-2">
                    <input id="rightCheckBox4" type="checkbox" checked class="checkbox2 rightCheckBox4"
                    rightCheckAttr="4" onchange="rightCheckbox(this,event)" />
                        ...
                        <div class="distributionCard1 equalDistCard1 position-relative w-100">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="radioBtnDiv greenRadioSwtch r2" id="button-2">
                                    <input type="checkbox" class="checkbox2 commonRadioBtn1 bigBaCard1"
                                    checked bigProgBar="1" onchange="bigProgressbar(this, event)" />
                                    <div class="knobs2"></div>
                                    <div class="layer2"></div>
                                </div>
                                </div>
                            ...
                            <p class="ms-2 CardProgressnym carValue1 position-up2"><span>Cumulative
                            ...
                            <div class="add-note-input-div d-none">
                                ...
                                <button class="btn"><img src="@/assets/images/icons/check-blue.svg"
                                    class="img-fluid" alt="Check"></button>
                                </div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="distributionCard1 equalDistCard2 position-relative w-100">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="radioBtnDiv r2 blueRadioSwtch" id="button-2">
                                    <input type="checkbox" class="checkbox2 commonRadioBtn1 bigBaCard2"
                                    checked bigProgBar="2" onchange="bigProgressbar(this,event)" />
                                    <div class="knobs2"></div>
                                    <div class="layer2"></div>
                                </div>
                                </div>
                        ...
                        <div class="distributionCard1 equalDistCard3 position-relative w-100">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="radioBtnDiv r2 voiletRadioSwtch" id="button-2">
                                    <input type="checkbox" class="checkbox2 commonRadioBtn1 bigBaCard3"
                                    checked bigProgBar="3" onchange="bigProgressbar(this,event)" />
                                    <div class="knobs2"></div>
                                    <div class="layer2"></div>
                                </div>
                                </div>
                        ...
                        <div class="distributionCard1 equalDistCard4 position-relative w-100">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="radioBtnDiv r2 redRadioSwtch" id="button-2">
                                    <input type="checkbox" class="checkbox2 commonRadioBtn1 bigBaCard4"
                                    checked bigProgBar="4" onchange="bigProgressbar(this,event)" />
                                    <div class="knobs2"></div>
                                    <div class="layer2"></div>
                                </div>
                                </div>
                    ...
                    <div class="d-flex justify-content-between flex-gap-12">
                        ...
                        <div class="distributionCard1 equalDistCard1 position-relative w-100">
                            ...
                            <div class="d-flex">
                                <div class="button-cover2">
                                <div class="radioBtnDiv greenRadioSwtch r2" id="button-2">
                                    <input type="checkbox" class="checkbox2 commonRadioBtn1 bigBaCard5"
                                    checked bigProgBar="5" onchange="bigProgressbar(this,event)" />
                                    <div class="knobs2"></div>
                                    <div class="layer2"></div>
                                </div>
                                </div>
                            ...
                            <p class="ms-2 CardProgressnym carValue1 position-up2"><span>Total
                                Value</span><br /> $85,044</p>
                            </div>
                            <div class="d-flex justify-content-center addNotesMainDiv">
                            <button type="button" class="AddNoteBtn">Add Note</button>
                            <div class="add-note-input-div d-none">
                        ...
                        <div class="distributionCard1 equalDistCard2 position-relative w-100">
                            ...
                            <div class="d-flex">
                                <div class="button-cover2">
                                <div class="radioBtnDiv r2 blueRadioSwtch" id="button-2">
                                    <input type="checkbox" class="checkbox2 commonRadioBtn1 bigBaCard6"
                                    checked bigProgBar="6" onchange="bigProgressbar(this,event)" />
                                    <div class="knobs2"></div>
                                    <div class="layer2"></div>
                                </div>
                                </div>
                        ...
                        <div class="distributionCard1 equalDistCard3 position-relative w-100">
                            ...
                            <div class="d-flex">
                                <div class="button-cover2">
                                <div class="radioBtnDiv r2 voiletRadioSwtch" id="button-2">
                                    <input type="checkbox" class="checkbox2 commonRadioBtn1 bigBaCard7"
                                    checked bigProgBar="7" onchange="bigProgressbar(this,event)" />
                                    <div class="knobs2"></div>
                                    <div class="layer2"></div>
                                </div>
                                </div>
                        ...
                        <div class="distributionCard1 equalDistCard4 position-relative w-100">
                            ...
                            <div class="d-flex">
                                <div class="button-cover2">
                                <div class="radioBtnDiv r2 redRadioSwtch" id="button-2">
                                    <input type="checkbox" class="checkbox2 commonRadioBtn1 bigBaCard8"
                                    checked bigProgBar="8" onchange="bigProgressbar(this,event)" />
                                    <div class="knobs2"></div>
                                    <div class="layer2"></div>
                                </div>
                                </div>
