<template>
  <div class="modal fade common-modal" ref="createReportModal2" id="reportCreateModal2" tabindex="-1" aria-labelledby="reportCreateModal2Label"
    aria-hidden="true">
...
export default {
  mounted() {
    if (this.$store.getters.checkActiveModal("create_new_client_report_modal")) {
