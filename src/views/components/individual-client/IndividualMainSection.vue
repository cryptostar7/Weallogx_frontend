            ...
            <div class="client-list-div less-gap">
              <div class="list-wrapper listWrapperDarkBg">
                ...
                <ul class="nav flex-column client-list-ul">
                  <li class="nav-item clientAllListItem">
                    <div class="list-groups">
                      <div class="list-div">
                        <div
                          v-if="client.scenarios && client.scenarios.length > 0"
                          class="list-div"
                        >
                          <ScenariosRow
                            :clientId="client.id"
                ...
                <button
                  ...
                  @click="$router.push(`/scenario-details?client=${client.id}`)"
                >
                  <span>+</span>
                </button>
              </div>
              ...
              <div class="list-wrapper listWrapperDarkBg">
                ...
                <button
                  ...
                  @click="$router.push(`/report-builder?client=${client.id}`)"
                >
                  <span>+</span>
                </button>
              </div>
