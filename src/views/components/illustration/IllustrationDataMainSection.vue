  ...
  <section class="main-section">
    <div class="reviewProgressMainDiv py-5">
       <ul class="mt-1 review-progress" id="reviewProgress">
        ...
        <li class="active"><router-link to="/illustration-data" class="nav-link p-0">Illustration Data</router-link></li>
            ...
            <div class="form-wrapper side-grey-line">
              <div class="form-wrapper-inner">
                <div class="form-group less">
                  <label for="existingInsuranceProfiles" class="fs-14 bold-fw">Use Existing Insurance Profile</label>
                  <div class="p-relative">
                    <input type="text" id="existingInsuranceProfiles" placeholder="Select or Start Typing"
                ...
                <div class="pb-3">
                  <div class="form-check form-switch custom-switch createSenarioRadioBtn">
                    ...
                    <label class="form-check-label fs-12 semi-bold-fw mb-0" for="scheduleTemplateCheckbox">Save this
                      Insurance Company Profile</label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="p-relative">
                    <input type="text" id="existingIllustration" placeholder="Select or Start Typing"
                      class="form-control pe-5 autocomplete">
                    <span class="chevron-span">
                      <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <ul class="nav nav-tabs tax-rate-tabs" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="uploadFromFile-tab" data-bs-toggle="tab"
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="copyPaste-tab" data-bs-toggle="tab" data-bs-target="#copyPaste"
                      type="button" role="tab" aria-controls="copyPaste" aria-selected="false">
                  ...
                  <div class="tab-pane fade show active" id="uploadFromFile" role="tabpanel"
                    ...
                    <div class="pb-4">
                      <label for="uploading" class="drag-drop-label d-block text-center">
                        ...
                        <span><img src="@/assets/images/icons/table-drag.svg" class="img-fluid" alt="Drag & Drop"></span>
                              ...
                              <tr>
                                <td>
                                  <div class="d-flex flex-column align-items-center px-2">
                                    <button class="btn col-delete-btn" data-bs-toggle="modal" data-bs-target="#deleteColumnModal"><img src="@/assets/images/icons/delete-grey.svg"
                                        class="img-fuid" alt="Delete"></button>
                          ...
                          <table class="illustrative-data-table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="text-end">$488,661</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$530,798</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$536,889</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$545,148</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$552,017</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$560,415</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$566,806</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$575,998</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                              ...
                              <!--   <td>
                                ...
                                <td>
                                  <div class="text-end">$598,000</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$605,113</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                               ...
                               <!--  <td>
                                ...
                                <td>
                                  <div class="text-end">$610,221</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                               ...
                               <!--  <td>
                                ...
                                <td>
                                  <div class="text-end">$614,265</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$620,354</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$624,557</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$632,049</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                               ...
                               <!--  <td>
                                ...
                                <td>
                                  <div class="text-end">$638,251</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                              ...
                              <!--   <td>
                                ...
                                <td>
                                  <div class="text-end">$642,025</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$648,156</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td>
                                  <div class="text-end">$654,046</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
              ...
              <div class="text-center mt-30">
                <router-link to="/comparative-vehicles" class="nav-link btn form-next-btn fs-14 active"
                  disabled="true">Next</router-link>
                <span class="d-block mb-2"></span>
                <router-link to="/create-new-scenario" class="nav-link btn form-back-btn fs-14" disabled="true"><img
...
export default {
  mounted() {
    ...
    const existingIllustrationList = [
      "Illustration One",
      "Illustration Two",
      "Illustration Three",
      "Illustration Four",
    ...
    autocomplete(document.getElementById("existingInsuranceProfiles"), clients);
    autocomplete(
      document.getElementById("existingIllustration"),
