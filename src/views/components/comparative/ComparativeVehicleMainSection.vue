              ...
              <div class="form-wrapper side-grey-line">
                <div class="form-wrapper-inner no-style newScenarioVehicleInner">
                  ...
                  <SelectDropdown
                    ...
                    :error="errors.existing_portfolio"
                    @clearError="() => (errors.existing_portfolio = false)"
                    @onSelectItem="setExistingPortfolioId"
                    @inputText="setExistingPortfolioName"
                  />
                  <div
                    :class="`comparative-vehicle-tab-wrapper ${vehicle.tab ? '' : 'noVehicleTyupeSelectPadd'} mb-3`"
                  ...
                  >
                    <ul class="nav nav-tabs comparative-vehicle-tabs" role="tablist">
                      <li class="nav-item" role="presentation" @click="setVehicleTab(1)">
                        <button
                          :class="`nav-link ${
                            vehicle.tab === 1 && tabs.vehicle1 ? 'active' : `${tabs.vehicle1 ? 'activeOnly' : ''}`
                          }`"
                          id="vehicleType1-tab"
                          type="button"
                          role="tab"
                        ...
                        >
                          <div class="form-check form-switch custom-switch"> 
                            <input
                              ...
                              checked="true"
                            />
                            <label class="form-check-label no-event fs-12 semi-bold-fw mb-0">Vehicle #1</label>
                          </div>
                        </button>
                      </li>
                      <li class="nav-item" role="presentation" @click="setVehicleTab(2)">
                        <button
                          :class="`nav-link ${
                            vehicle.tab === 2 && tabs.vehicle2 ? 'active' : `${tabs.vehicle2 ? 'activeOnly' : ''}`
                          }`"
                          id="vehicleType2-tab"
                          type="button"
                          role="tab"
                        ...
                        >
                          <div class="form-check form-switch custom-switch"> 
                            <input
                              ...
                              @click="setActiveTab2"
                            />
                            <label class="form-check-label no-event fs-12 semi-bold-fw mb-0" @click="setActiveTab2">
                              Vehicle #2
                            </label>
                          </div>
                        </button>
                      ...
                      <li class="nav-item" role="presentation" @click="setVehicleTab(3)">
                        <button
                          :class="`nav-link ${
                            vehicle.tab === 3 && tabs.vehicle3 ? 'active' : `${tabs.vehicle3 ? 'activeOnly' : ''}`
                          }`"
                          id="vehicleType3-tab"
                          type="button"
                          role="tab"
                        ...
                        >
                          <div class="form-check form-switch custom-switch"> 
                            <input
                              ...
                              @click="setActiveTab3"
                            />
                            <label class="form-check-label no-event fs-12 semi-bold-fw mb-0" @click="setActiveTab3">
                              Vehicle #3
                            </label>
                          </div>
                        </button>
                    ...
                    <form class="tab-content" autocomplete="off">
                      <div
                        :class="`tab-pane ${vehicle.tab === 1 ? 'active' : ''}`"
                        id="vehicleType1Tab"
                        role="tabpanel"
                        aria-labelledby="vehicleType1-tab"
                      >
                        <SelectDropdown
                          :list="dropdown.VehicleType"
                          label="Vehicle Type 1"
                          id="comparativeVehicleType"
                          class="form-group less pt-3"
                          :error="errors.vehicle1.type_id"
                          @clearError="() => (errors.vehicle1.type_id = false)"
                          :defaultSelected="defaultVehicle.vehicle1.template_name" @onSelectItem="(e) => setVehicleType(1, e)"
                          @inputText="(e) => setVehicleTypeName(1, e)"
                          :showAll="true"
                        />
                        <div
                          :class="`${this.vehicle.vehicle1.type_id && vehicleSelected ? '' : 'vehicleaTypeArea'} mt-4`"
                          id="taxableArea1"
                        >
                          <SelectDropdown
                            :list="existingVehicles1"
                            label="Use Existing Comparative Vehicle"
                            id="comparativeVehicleType"
                            :error="errors.existing_vehicle1"
                            @clearError="() => (errors.existing_vehicle1 = false)"
                            @onSelectItem="(e) => setExistingVehicle(1, e)"
                            @inputText="(e) => setExistingVehicleName(1, e)"
                          />
                          ...
                          <div class="form-group pt-2 less"> 
                            ...
                            <input
                              type="text"
                              id="scenarioName"
                              v-model="vehicle.vehicle1.name"
                              class="form-control"
                              @keyup="() => (errors.vehicle1.name = false)"
                            />
                          ...
                          <div class="form-group less">
                            ...
                            <textarea
                              ...
                              rows="2"
                              class="form-control"
                              v-model="vehicle.vehicle1.description"
                            ></textarea>
                            <small class="text-danger" v-if="errors.vehicle1.description">
                              {{ errors.vehicle1.description[0] }}
                            </small>
                          </div>
                          <div class="form-group-wrapper">
                            ...
                            <div class="form-group">
                              ...
                              <small class="text-danger" v-if="errors.vehicle1.fees">
                                {{ errors.vehicle1.fees[0] }}
                              </small>
                            </div>
                          </div>
                          <div class="pb-2">
                            <div class="form-check form-switch custom-switch preAfeCapitalSwtch">
                              <input
                                ...
                                role="switch"
                                id="capitalGainTax1"
                                v-model="vehicle.vehicle1.capitalGains"
                                :checked="vehicle.vehicle1.capitalGains"
                              />
                              <label
                              ...
                              >
                                {{ vehicle.vehicle1.type_id === 1 ? 'Capital Gains Tax' : 'Pre Age 59 ½ Penalty' }}
                              </label>
                            </div>
                            <div
                              :class="`form-group-wrapper ${
                                vehicle.vehicle1.capitalGains && vehicle.vehicle1.type_id === 1
                                  ? ''
                                  : 'capitalDisplayNone'
                              } pt-2`"
                            ...
                            >
                              <div class="form-group pb-0 m-0">
                                ...
                                <small class="text-danger" v-if="errors.vehicle1.cg_tax">
                                  {{ errors.vehicle1.cg_tax[0] }}
                                </small>
                              </div>
                              <div class="form-group pb-0 m-0">
                                <label for="percent_of_account_as_cg1" class="fs-12 semi-bold-fw">
                                ...
                                <small class="text-danger" v-if="errors.vehicle1.cg_percent">
                                  {{ errors.vehicle1.cg_percent[0] }}
                                </small>
                              </div>
                            </div>
                            <div class="form-check form-switch custom-switch mt-3"> 
                              <input
                                ...
                                v-model="vehicle.vehicle1.templateCheckbox"
                              />
                          ...
                          <div
                            :style="{
                              display: vehicle.vehicle1.templateCheckbox ? 'unset' : 'none'
                            }"
                          ...
                          >
                            ...
                            <input
                              ...
                              class="form-control"
                              v-model="vehicle.vehicle1.template_name"
                            />
                          </div>
                        </div>
                      </div>
                      <div
                        :class="`tab-pane ${vehicle.tab === 2 ? 'active' : ''}`"
                        id="vehicleType2Tab"
                        role="tabpanel"
                      ...
                      >
                        <SelectDropdown
                          ...
                          class="form-group less pt-3"
                          :error="errors.vehicle2.type_id"
                          @clearError="() => (errors.vehicle2.type_id = false)"
                          :defaultSelected="defaultVehicle.vehicle2.template_name"
                          @onSelectItem="(e) => setVehicleType(2, e)"
                          @inputText="(e) => setVehicleTypeName(2, e)"
                          :showAll="true"
                        />
                        <div :class="`${vehicle.vehicle2.type_id ? '' : 'vehicleaTypeArea'} mt-4`" id="taxableArea2">
                          <SelectDropdown
                            :list="existingVehicles2"
                            label="Use Existing Comparative Vehicle"
                            id="comparativeVehicleType"
                            :error="errors.existing_vehicle2"
                            @clearError="() => (errors.existing_vehicle2 = false)"
                            @onSelectItem="(e) => setExistingVehicle(2, e)"
                            @inputText="(e) => setExistingVehicleName(2, e)"
                          />
                           <span class="or-text-span">or</span>
                          <h4 class="form-subheading fs-14 fw-bold"> Create From Scratch </h4>
                          <div class="form-group pt-2 less"> 
                            ...
                            <input
                              ...
                              id="scenarioName"
                              class="form-control"
                              v-model="vehicle.vehicle2.name"
                              @keyup="() => (errors.vehicle2.name = false)"
                            />
                          ...
                          <div class="form-group less">
                            ...
                            <textarea
                              ...
                              rows="2"
                              class="form-control"
                              v-model="vehicle.vehicle2.description"
                            ></textarea>
                            <small class="text-danger" v-if="errors.vehicle2.description">
                              {{ errors.vehicle2.description[0] }}
                            </small>
                          </div>
                          <div class="form-group-wrapper">
                            <div class="form-group">
                          ...
                          <div class="pb-2">
                            <div class=" form-check form-switch custom-switch preAfeCapitalSwtch2">
                              <input
                                ...
                                role="switch"
                                id="capitalGainTax2"
                                v-model="vehicle.vehicle2.capitalGains"
                                :checked="vehicle.vehicle2.type_id === 1 ? false : true"
                              />
                              <label
                                class="form-check-label fs-12 semi-bold-fw mb-0"
                                for="capitalGainTax2"
                              ...
                              >
                                {{ vehicle.vehicle2.type_id === 1 ? 'Capital Gains Tax' : 'Pre Age 59 ½ Penalty' }}
                              </label>
                            </div>
                            <div
                              :class="`form-group-wrapper ${
                                vehicle.vehicle2.capitalGains && vehicle.vehicle2.type_id === 1
                                  ? ''
                                  : 'capitalDisplayNone'
                              } pt-2`"
                            ...
                            >
                              <div class="form-group pb-0 m-0">
                                ...
                                <small class="text-danger" v-if="errors.vehicle2.cg_tax">
                              ...
                              <div class="form-group pb-0 m-0">
                                ...
                                <small class="text-danger" v-if="errors.vehicle2.cg_percent">
                                  {{ errors.vehicle2.cg_percent[0] }}
                                </small>
                              </div>
                            </div>
                            <div class="form-check form-switch custom-switch mt-3">
                              <input
                                ...
                                v-model="vehicle.vehicle2.templateCheckbox"
                              />
                              <label class="form-check-label fs-12 semi-bold-fw mb-0" for="saveVehicleTempName2">
                                Save this Vehicle as Template
                              </label>
                            </div>
                          </div>
                          <div
                            :style="{
                              display: vehicle.vehicle2.templateCheckbox ? 'unset' : 'none'
                            }"
                            class="form-group less"
                            id="vehicleTempName2"
                          >
                            ...
                            <input
                              ...
                              id="vehicleTemplateName"
                              class="form-control"
                              v-model="vehicle.vehicle2.template_name"
                            />
                          </div>
                        </div>
                      </div>
                      <div
                        :class="`tab-pane ${vehicle.tab === 3 ? 'active' : ''}`"
                        id="vehicleType3Tab"
                        role="tabpanel"
                      ...
                      >
                        <SelectDropdown
                          ...
                          class="form-group less pt-3"
                          :error="errors.vehicle3.type_id"
                          @clearError="() => (errors.vehicle3.type_id = false)"
                          :defaultSelected="defaultVehicle.vehicle3.template_name"
                          @onSelectItem="(e) => setVehicleType(3, e)"
                          @inputText="(e) => setVehicleTypeName(3, e)"
                          :showAll="true"
                        />
                        <div :class="`${vehicle.vehicle3.type_id ? '' : 'vehicleaTypeArea'} mt-4`" id="taxableArea3">
                          <SelectDropdown
                            :list="existingVehicles3"
                            label="Use Existing Comparative Vehicle"
                            id="comparativeVehicleType"
                            :error="errors.existing_vehicle3"
                            @clearError="() => (errors.existing_vehicle3 = false)"
                            @onSelectItem="(e) => setExistingVehicle(3, e)"
                            @inputText="(e) => setExistingVehicleName(3, e)"
                          />
                          <span class="or-text-span">or</span>
                          <h4 class="form-subheading fs-14 fw-bold">Create From Scratch</h4>
                          <div class="form-group pt-2 less"> 
                            ...
                            <input
                              ...
                              id="scenarioName"
                              class="form-control"
                              v-model="vehicle.vehicle3.name"
                              @keyup="() => (errors.vehicle3.name = false)"
                            />
                          ...
                          <div class="form-group less">
                            ...
                            <textarea
                              ...
                              rows="2"
                              class="form-control"
                              v-model="vehicle.vehicle3.description"
                            ></textarea>
                            <small class="text-danger" v-if="errors.vehicle3.description">
                              {{ errors.vehicle3.description[0] }}
                            </small>
                          </div>
                          <div class="form-group-wrapper">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <small class="text-danger" v-if="errors.vehicle3.fees">
                                {{ errors.vehicle3.fees[0] }}
                              </small>
                            </div>
                          </div>
                          <div class="pb-2">
                            <div class=" form-check form-switch custom-switch preAfeCapitalSwtch3">
                              <input
                                ...
                                role="switch"
                                id="capitalGainTax3"
                                v-model="vehicle.vehicle3.capitalGains"
                                :checked="vehicle.vehicle3.type_id === 1 ? false : true"
                              />
                              <label
                                class="form-check-label fs-12 semi-bold-fw mb-0"
                                for="capitalGainTax3"
                              ...
                              >
                                {{ vehicle.vehicle3.type_id === 1 ? 'Capital Gains Tax' : 'Pre Age 59 ½ Penalty' }}
                              </label>
                            </div>
                            <div
                              :class="`form-group-wrapper ${
                                vehicle.vehicle3.capitalGains && vehicle.vehicle3.type_id === 1
                                  ? ''
                                  : 'capitalDisplayNone'
                              } pt-2`"
                            ...
                            >
                              <div class="form-group pb-0 m-0">
                                ...
                                <small class="text-danger" v-if="errors.vehicle3.cg_tax">
                                  {{ errors.vehicle3.cg_tax[0] }}
                                </small>
                              </div>
                              <div class="form-group pb-0 m-0">
                                <label for="percent_of_account_as_cg3" class="fs-12 semi-bold-fw">
                                  % of Account as Capital Gains
                                </label>
                                <div class="percent-input-div">
                                  <input
                                ...
                                <small class="text-danger" v-if="errors.vehicle3.cg_percent">
                                  {{ errors.vehicle3.cg_percent[0] }}
                                </small>
                              </div>
                            </div>
                            <div class="form-check form-switch custom-switch mt-3">
                              <input
                                ...
                                v-model="vehicle.vehicle3.templateCheckbox"
                              />
                              <label class="form-check-label fs-12 semi-bold-fw mb-0" for="saveVehicleTempName3">
                                Save this Vehicle as Template
                              </label>
                            </div>
                          </div>
                          <div
                            :style="{ display: vehicle.vehicle3.templateCheckbox ? 'unset' : 'none' }"
                            class="form-group less"
                            id="vehicleTempName3"
                          >
                            <label for="vehicleTemplateName" class="fs-12 semi-bold-fw">Vehicle Template Name</label>
                            <input
                              ...
                              id="vehicleTemplateName"
                              class="form-control"
                              v-model="vehicle.vehicle3.template_name"
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-9">
                    <div class="bottom-buttons-main-div">
                      <div class="text-center" v-if="vehicle.tab !== 3"> 
                        <a href="javascript:void(0)" class="btn AdtnlCmprtVhclBtn fs-14" @click="setNextTab()">
                          Add Additional Comparative Vehicle
                        </a>
                      </div>
                      <div
                        :class="`form-check form-switch custom-switch align-items-center d-flex justify-content-center mb-3 mt-30 ${
                          tabs.vehicle2 && vehicle.tab !== 1 ? '' : 'd-none'
                        }`"
                      >
                        <input
                          ...
                          type="checkbox"
                          role="switch"
                          id="saveComparativePortPolio"
                          v-model="vehicle.portfolio_checkbox"
                        />
                        <label class="form-check-label fs-12 semi-bold-fw mb-0" for="saveComparativePortPolio">
                          Save as Comparative Vehicle Portfolio
                        </label>
                      </div>
                      <div
                        :class="`form-group less width-adjust ${
                          vehicle.portfolio_checkbox && tabs.vehicle2 && vehicle.tab !== 1 ? '' : 'd-none'
                        }`"
                      ...
                      >
                        ...
                        <input
                          type="text"
                          id="portfolioTemplateName"
                          class="form-control width-adjust"
                          v-model="vehicle.portfolio_name"
                          autocomplete="off"
                        />
                      </div>
                    </div>
                  ...
                  <div class="col-md-12">
                    <div class="text-center mt-30 d-flex flex-column justify-content-center p-relative">
                      <div class="d-flex justify-content-center">
                        <div>
                          <router-link
                            :to="`/${$route.query.review === 'true' ? 'review-summary' : 'illustration-data'}/${
                    ...
                    <div class="d-flex justify-content-center pt-3">
                      <button
                        ...
                        :class="`nav-link btn form-back-btn mx-0 fs-14 flex-shrink-0 ${
                          $route.query.review === 'true' ? 'review-summary' : 'illustration-data'
                        }`"
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.params.scenario) {
      ...
      if (scenarioData && scenarioData.id === Number(this.$route.params.scenario)) {
  ...
  methods: {
    ...
    // get portfolio data
    getPortfolioData(id, portfolio = false) {
      if (!id) {
        return false;
      }
      this.$store.dispatch('loader', true);
    ...
    setExistingVehicleName(vType, name) {
      this.errors[`vehicle${vType}`] = [];
    ...
    getVehicleType(type = '') {
      var temp = this.dropdown.VehicleType.filter((item) => item.template_name === type)[0];
      return temp ? temp.id : false;
    },
    // to validate the existing portfolio template
    validatePortfolio() {
      if (this.existingPortfolioName) {
        let templateId = this.$getTemplateId(this.existingPortfolioName, this.cvPortfolios);
        if (templateId) {
    ...
    populateVehicle(vType, tempType = 1, data = []) {
    ...
    checkVechicle1() {
      let templateId = this.$getTemplateId(this.vehicle.vehicle1.type, this.dropdown.VehicleType);
      if (templateId) {
    ...
    checkVechicle2() {
      let templateId = this.$getTemplateId(this.vehicle.vehicle2.type, this.dropdown.VehicleType);
    ...
    checkVechicle3() {
      let templateId = this.$getTemplateId(this.vehicle.vehicle3.type, this.dropdown.VehicleType);
      if (templateId) {
    ...
    validateVehicle1() {
      ...
      if (this.vehicle.vehicle1.existing.name) {
        ...
        let templateId = this.$getTemplateId(this.vehicle.vehicle1.existing.name, this.existingVehicles);
        ...
        if (this.vehicle.vehicle1.type) {
          ...
          this.vehicle.vehicle1.cg_tax_rate = this.getInputUsingId('cg_tax_rate1');
          this.vehicle.vehicle1.percent_of_account_as_cg = this.getInputUsingId('percent_of_account_as_cg1');
    ...
    validateVehicle2() {
      ...
      if (this.vehicle.vehicle2.existing.name) {
        ...
        let templateId = this.$getTemplateId(this.vehicle.vehicle2.existing.name, this.existingVehicles);
        if (!templateId || !this.getTemplateDataId(templateId)) {
          valid = false;
        ...
        if (this.vehicle.vehicle2.type) {
          ...
          this.vehicle.vehicle2.cg_tax_rate = this.getInputUsingId('cg_tax_rate2');
          this.vehicle.vehicle2.percent_of_account_as_cg = this.getInputUsingId('percent_of_account_as_cg2');
    ...
    validateVehicle3() {
      ...
      if (this.vehicle.vehicle3.existing.name) {
        ...
        let templateId = this.$getTemplateId(this.vehicle.vehicle3.existing.name, this.existingVehicles);
        if (!templateId || !this.getTemplateDataId(templateId)) {
          valid = false;
        ...
        if (this.vehicle.vehicle3.type) {
          ...
          this.vehicle.vehicle3.cg_tax_rate = this.getInputUsingId('cg_tax_rate3');
          this.vehicle.vehicle3.percent_of_account_as_cg = this.getInputUsingId('percent_of_account_as_cg3');
    ...
    submitHandler(e, review = false, report = false) {
      ...
      var data = {
        vehicle_type_1: {
          ...
          capital_gain_tax_checkbox:
            this.vehicle.vehicle1.capitalGains && this.vehicle.vehicle1.type_id === 1 ? true : false,
          pre_age_59_penality: this.vehicle.vehicle1.capitalGains && this.vehicle.vehicle1.type_id !== 1 ? true : false,
        ...
        vehicle_type_3: {
          ...
          capital_gain_tax_checkbox:
            this.vehicle.vehicle3.capitalGains && this.vehicle.vehicle3.type_id === 1 ? true : false,
          pre_age_59_penality: this.vehicle.vehicle3.capitalGains && this.vehicle.vehicle3.type_id !== 1 ? true : false,
      ...
      if (this.cvId) {
          ...
          .then((response) => {
            ...
            this.$router.push(
              `/${
                review
                  ? 'review-summary'
                  : scenarioData.historical
                  ? 'historical-index-strategy-allocation'
                  : 'select-historical-simulations'
        ...
        post(getUrl('comparative'), formData, authHeader())
          .then((response) => {
            ...
            this.getExistingVehicles();
            this.$toast.success(response.data.message);
            this.$router.push(`/select-historical-simulations/${this.$route.params.scenario}`);
          })
          .catch((error) => {
            if (error.code === 'ERR_BAD_RESPONSE' || error.code === 'ERR_NETWORK') {
              this.$toast.error(error.message);
