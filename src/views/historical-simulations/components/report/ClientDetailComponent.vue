<template lang="">
    <div v-if="!$store.state.app.presentation_mode && comparative.client_firstname" class="section-heading-div extra report section-heading-bg pt-2 d-flex justify-content-between gap-20 flex-wrap flex-md-nowrap align-items-center">
        <div class="d-flex align-items-center">
          ...
          <div class="d-flex align-items-center">
            <button class="editBtnLirp btn" data-bs-target="#ReportBuilderNameEditModal" data-bs-toggle="modal">
