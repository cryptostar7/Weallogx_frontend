...
export default {
  ...
  mounted() {
    ...
    if (card2) {
      ...
      this.data.cummulative_income[1].starting_date = this.$customDateFormat(
        card2.starting_date,
        "M/D/y"
      );
      ...
      this.data.total_income[1].starting_date = this.$customDateFormat(
        card2.starting_date,
        "M/D/y"
      );
    ...
    if (card3) {
      ...
      this.data.cummulative_income[2].starting_date = this.$customDateFormat(
        card3.starting_date,
        "M/D/y"
      );
      ...
      this.data.total_income[2].starting_date = this.$customDateFormat(
        card3.starting_date,
        "M/D/y"
      );
    ...
    if (card4) {
      ...
      this.data.cummulative_income[3].starting_date = this.$customDateFormat(
        card4.starting_date,
        "M/D/y"
      );
      ...
      this.data.total_income[3].starting_date = this.$customDateFormat(
        card4.starting_date,
        "M/D/y"
      );
    ...
    if (card5) {
      ...
      this.data.cummulative_income[4].starting_date = this.$customDateFormat(
        card5.starting_date,
        "M/D/y"
      );
      ...
      this.data.total_income[4].starting_date = this.$customDateFormat(
        card5.starting_date,
        "M/D/y"
      );
