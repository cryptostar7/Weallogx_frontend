<template lang="">
  ...
  >
    <div class="fill" data-class="empty-fill" draggable="true" data-fill="4">
      ...
      >
        <div
          :class="`ComparativeTableMainDiv rightDivTop10 ${
        ...
        >
          <div class="d-flex justify-content-between px-3 py-2 bb-grey">
            <div class="d-flex align-items-center">
              <div class="button-cover2 prstnRadioBtnHide">
                <div class="radioBtnDiv r2" id="button-2">
                  <input
                    ...
                    class="checkbox2 rightCheckBox10"
                    rightCheckAttr="10"
                    @change="
                      () =>
              ...
              <label for="rightCheckBox10" class="rghtTopHeadcommon"
                >Total Value<span class="ms-3 equalThingTabTxt"
                  >(Graph)</span
                ></label
              >
            </div>
          ...
          <div
            class="collapseDivMain collapseDiv10"
          ...
          >
            ...
            <div class="px-3 pt-3 pb-2">
                      ...
                      >
                        ...
                        <label
                          ...
                          /><span :class="`info-message-rollingTime`">
                            ...
                            ><br />
                            <span>Starting Date: {{ item.starting_date }}</span>
                          </span></label
                        >
                      </p>
                      <div class="mt-2 d-flex">
                        <div
                          :class="`CardProgressBar lessWidth lightProgress${
                            1 + index
                          } boxProgressCommon${14 + index} totalValueProgress${
                            1 + index
              ...
              <div class="container-fluid">
                <div
                  class="graph-container-div graph-area"
                  id="totalValueGraphArea"
                >
...
export default {
  ...
  methods: {
    ...
    getDataSet: function () {
      let lirpCard = this.historical.lirp_data;
      let recentCard = this.historical.recent;
      let worstData = this.historical.worst;
      let medianCard = this.historical.median;
      let bestCard = this.historical.best;
      ...
      if (lirpCard) {
        value1 =
          lirpCard.chart_output.total_values.map((i, idx) => {
      ...
      if (!this.deletedItems.includes(1) && recentCard) {
        value2 =
          recentCard.total_value.total_value_graph.map((i, idx) => {
            return { x: idx + 1, y: i.toFixed(0) };
          }) || [];
      }

      if (!this.deletedItems.includes(2) && worstData) {
        value3 =
          worstData.total_value.total_value_graph.map((i, idx) => {
            return { x: idx + 1, y: i.toFixed(0) };
          }) || [];
      }
      ...
      if (!this.deletedItems.includes(3) && medianCard) {
        value4 =
          medianCard.total_value.total_value_graph.map((i, idx) => {
            return { x: idx + 1, y: i.toFixed(0) };
          }) || [];
      }
      ...
      if (!this.deletedItems.includes(4) && bestCard) {
        value5 =
          bestCard.total_value.total_value_graph.map((i, idx) => {
            return { x: idx + 1, y: i.toFixed(0) };
          }) || [];
      }
    ...
    setGraph: function () {
      ...
      const totalValueGraphArea = document.querySelector(
        "#totalValueGraphArea"
      );
      ...
      const previousY = (totalValueChart) =>
        totalValueChart.index === 0
          ? totalValueChart.chart.scales.y.getPixelForValue(
        ...
        afterEvent(chart, args) {
          ...
          if (args.inChartArea) {
            ...
            chart.getDatasetMeta(3).data[0]
              ...
              : bordercolors[5];
            chart.getDatasetMeta(4).data[0]
              ? (data.datasets[4].borderColor = setBorderColor(
                  chart.getDatasetMeta(4).data[0].active,
                  4,
                  bordercolors[4]
                ))
              : bordercolors[5];
        ...
        options: {
          ...
          scales: {
            ...
            y: {
              ...
              min: 0,
              suggestedMax: this.$roundFigureNum(Number(maxAxis)).toFixed(0),
              ticks: {
                padding: 8,
