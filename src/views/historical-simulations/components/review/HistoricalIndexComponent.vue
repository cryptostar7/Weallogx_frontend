    ...
    <div v-if="$props.data" :class="$props.col">
      <div class="compVehcleCol">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div
            :class="`${$props.col == 'col-lg-6' ? 'extra' : ''} ${
              $props.col == 'col-lg-12' ? 'extra' : ''
            } col summaryInputsDiv text-center`"
          >
            <label for="client name text-center">Weighting</label>
            <p class="summaryVehiclePara small-top-border pt-1">
              {{ weighting }}%
            </p>
          </div>
          <router-link
            :to="`/historical/parameters/${$route.params.simulation}?tab=${$props.tab}&review=true`"
          ...
          <div class="row gx-5">
            ...
            <div class="col-md-6 summaryInputsDiv">
              ...
              <p class="summaryVehiclePara pt-1">
                {{
                  Number($props.data.cap_rate) === 1000
                    ? "N/A"
                    : `${$props.data.cap_rate}%`
                }}
              </p>
            ...
            <div class="col-md-6 summaryInputsDiv">
              ...
              <p class="summaryVehiclePara pt-1">
                {{ `${$props.data.margin_spread}%` }}
              </p>
            </div>
            <div class="col-md-6 summaryInputsDiv">
              <label for="client name">Participation</label>
              <p class="summaryVehiclePara pt-1">
                {{ `${$props.data.participation_rate}%` }}
              </p>
            </div>
            <div class="col-md-6 summaryInputsDiv">
              <label for="client name">Segment Duration</label>
              <p class="summaryVehiclePara pt-1">
                {{ $props.data.segment_duration_years }}
              </p>
            </div>
          </div>
        </form>
          ...
          <div class="row gx-5">
            <div class="col-md-6 summaryInputsDiv">
              ...
              <input
                ...
                type="text"
                :class="`form-control ${
                  $props.data.performance_multiplier ? '' : 'NAData'
                }`"
                :value="
                  $props.data.performance_multiplier
                    ? $props.data.performance_multiplier_fixed_value_multiplier
                    : 'N/A'
                "
                readonly
              />
            ...
            <div class="col-md-6 summaryInputsDiv">
              ...
              <input
                ...
                :class="`form-control ${
                  $props.data.performance_multiplier &&
                  !$props.data.performance_multiplier_schedule_check
                    ? ''
                    : 'NAData'
                }`"
                :value="
                  $props.data.performance_multiplier &&
                  !$props.data.performance_multiplier_schedule_check
                    ? $props.data.performance_multiplier_fixed_value_start_year
                    : 'N/A'
                "
                readonly
              />
            ...
            <div class="col-md-6 summaryInputsDiv">
              ...
              <input
                ...
                type="text"
                :class="`form-control ${
                  $props.data.flat_fixed_value ? '' : 'NAData'
                }`"
                :value="
                ...
                @click="
                  setSchedule(
                    $props.data.flat_credit_schedule_rate ||
                      $props.data.flat_credit_schedule_amount,
                    $props.data.flat_credit_schedule_rate ? ' rate' : 'amount',
                    'Flat Credit/Bonus'
                  )
                "
              >
            ...
            <div class="col-md-6 summaryInputsDiv">
              ...
              <input
                ...
                :value="
                  $props.data.flat_fixed_value
                    ? $props.data.flat_fixed_start_year
                    : 'N/A'
                "
                readonly
              />
        ...
        <form action="">
          <div class="row gx-5">
            <div
              v-if="$props.data.performance_multiplier"
              class="col-md-6 summaryInputsDiv"
            >
              ...
              <p
                ...
                @click="
                  setSchedule(
                    $props.data
                      .performance_multiplier_fees_same_in_all_years_schedule,
                    'rate',
                    'Performance Mulitiplier Fee'
                  )
                "
              >
                Scheduled
            ...
            >
              ...
              <input
                ...
                :value="
                  $props.data.performance_multiplier_fees_same_in_all_years
                    ? 'Yes'
                    : 'No'
                "
                readonly
            ...
            <div
              v-if="$props.data.flat_credit_bonus"
              class="col-md-6 summaryInputsDiv"
            >
            ...
            >
              ...
              <input
                ...
                :value="
                  $props.data.flat_credit_bonus_fees_same_in_all_years
                    ? 'Yes'
                    : 'No'
                "
                readonly
