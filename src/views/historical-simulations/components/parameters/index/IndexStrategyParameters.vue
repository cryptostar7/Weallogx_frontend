      ...
      <div class="d-flex justify-content-center mt-4 mx-4" v-if="tabs.tab2">
        <div class="w-75">
          <div class="d-flex align-items-center mb-2">
            ...
            <label
              for="saveSimulationPortfolioCheckbox"
...
import SaveStrategyTemplate from "../index/SaveStrategyTemplate.vue";
...
export default {
  ...
  methods: {
    validateMultiplierSchedule: function () {
      ...
      if (
        !this.$refs.enhancementsParametersRef1.$refs.performanceMultiplierRef.validateScheduleData()
      ) {
        valid = false;
      }
      ...
      if (
        this.tabs.tab2 &&
        !this.$refs.enhancementsParametersRef2.$refs.performanceMultiplierRef.validateScheduleData()
      ) {
        valid = false;
      }
      ...
      if (
        this.tabs.tab3 &&
        !this.$refs.enhancementsParametersRef3.$refs.performanceMultiplierRef.validateScheduleData()
      ) {
        valid = false;
      }
    ...
    validateMultiplierScheduleFees: function () {
      ...
      if (!this.$refs.feesParametersRef1.validateMultiplerScheduleData()) {
        valid = false;
      }

      if (
        this.tabs.tab2 &&
        !this.$refs.feesParametersRef2.validateMultiplerScheduleData()
      ) {
        valid = false;
      }
      ...
      if (
        this.tabs.tab3 &&
        !this.$refs.feesParametersRef3.validateMultiplerScheduleData()
      ) {
        valid = false;
      }
    ...
    validateFlatCreditBonusSchedule: function () {
      ...
      if (
        !this.$refs.enhancementsParametersRef1.$refs.creditAndBonusRef.validateScheduleData()
      ) {
        valid = false;
      }
      ...
      if (
        this.tabs.tab2 &&
        !this.$refs.enhancementsParametersRef2.$refs.creditAndBonusRef.validateScheduleData()
      ) {
        valid = false;
      }
      ...
      if (
        this.tabs.tab3 &&
        !this.$refs.enhancementsParametersRef3.$refs.creditAndBonusRef.validateScheduleData()
      ) {
        valid = false;
      }
    ...
    validateFlatCreditBonusScheduleFees: function () {
      ...
      if (
        !this.$refs.feesParametersRef1.validateFlatCreditBonusScheduleData()
      ) {
        valid = false;
      }
      ...
      if (
        this.tabs.tab2 &&
        !this.$refs.feesParametersRef2.validateFlatCreditBonusScheduleData()
      ) {
        valid = false;
      }
      ...
      if (
        this.tabs.tab3 &&
        !this.$refs.feesParametersRef3.validateFlatCreditBonusScheduleData()
      ) {
        valid = false;
      }
