            ...
            <div class="right-area-wrapper">
              <section class="padding_right_section">
                <div class="retirement_buffer_section_head_div mb-5">
                  ...
                  <a href="accumulation-strategy.html" class="head_back_btn">
                                          ...
                                          <div class="tab-pane fade active show" id="v-pills-individual1" role="tabpanel">
                                            ...
                                            <div class="each-target-analysis-bar">
                                              <p class="heading clr1">
                                                FIA - Income Rider
                                                <span data-bs-toggle="modal" data-bs-target="#incomeRiderTableModal2">
                                            ...
                                            <div class="tab-content">
                                              <div class="tab-pane fade active show" id="v-pills-individual1" role="tabpanel">
                                                ...
                                                <div class="each-target-analysis-bar">
                                                  <p class="heading clr1">
                                                    FIA - Income Rider
                                                    <span data-bs-toggle="modal" data-bs-target="#incomeRiderTableModal2"><svg class="ms-1" xmlns="http://www.w3.org/2000/svg" width="17" height="15" viewBox="0 0 13 11" fill="none">
