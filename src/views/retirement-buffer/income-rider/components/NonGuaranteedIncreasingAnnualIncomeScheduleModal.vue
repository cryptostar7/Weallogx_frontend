<template lang>
  <div>
    <div
      class="modal fade"
      id="NonGuaranteedIncreasingAnnualIncomeScheduleModal"
      tabindex="-1"
          ...
          <div class="accumulation_strategy_box">
            ...
            <div class="income-rider-modal-body">
              <div
                ...
                <div
                  :class="this.inputs.non_guaranteed_income_type === 'mannual' ? 'active' : ''"
                  data-bs-toggle="pill"
                  data-bs-target="#year-by-year-tab2"
                  type="button"
                  role="tab"
                  aria-controls="year-by-year-tab2"
                  :aria-selected="this.inputs.non_guaranteed_income_type === 'mannual'"
                  @click="updateInput('non_guaranteed_income_type', 'mannual')">
                  Year by Year
                </div>
                <div
                  :class="this.inputs.non_guaranteed_income_type === 'year_bounded' ? 'active' : ''"
                  data-bs-toggle="pill"
                  data-bs-target="#first-and-last-year-tab2"
                  type="button"
                  role="tab"
                  aria-controls="first-and-last-year-tab2"
              ...
              <div class="tab-content" id="nav-tabContent">
                <div
                  :class="`tab-pane fade ${this.inputs.non_guaranteed_income_type === 'mannual' ? 'show active' : ''}`"
                  id="year-by-year-tab2"
                  role="tabpanel"
