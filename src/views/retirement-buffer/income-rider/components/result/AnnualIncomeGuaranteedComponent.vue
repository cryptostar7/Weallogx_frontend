      ...
      <div class="CompMainProgrssBarDiv graph-area">
        ...
        <div class="w-100 p-3">
          ...
          <div class="d-flex justify-content-center mt-2">
            <div class="nav mltplSwtchDiv nav-pills" role="tablist" aria-orientation="vertical" id="card-area-1">
              <div @click="
                ...
                " :class="targetAnalysis == 'amount' ? 'active' : ''" type="button" data-bs-toggle="pill" role="tab">
                Amount
              </div>
              <div data-bs-toggle="pill" @click="
                $store.dispatch(
                  'incomeRider/updateTargetAnalysisType',
                  'longevity'
                )
                " :class="targetAnalysis == 'longevity' ? 'active' : ''" role="tab">
                Longevity
              </div>
              <div data-bs-toggle="pill" @click="
                $store.dispatch(
                ...
                " :class="targetAnalysis == 'return' ? 'active' : ''" role="tab">
                Return
              </div>
            </div>
          </div>
          <div v-if="targetAnalysis != 'return'" class="d-flex justify-content-center mt-2 w-25 mx-auto">
            <div class="nav SwtchBtnRprtBldr nav-pills" role="tablist" aria-orientation="vertical">
              <div :class="`${showResult < 3 ? 'active' : ''}`" type="button" role="tab" aria-selected="true" @click="$store.dispatch('incomeRider/updateViewResult', 0)">
                Individual
              </div>
              <div :class="`${showResult > 2 ? 'active' : ''}`" type="button" role="tab" aria-selected="false" @click="$store.dispatch('incomeRider/updateViewResult', 3)">
                Show All
              </div>
            </div>
          </div>
          <div class="tab-content incomeRider-tab-content">
                ...
                <div class="tab-pane fade active show" id="v-pills-individual1" role="tabpanel">
                  ...
                  <div class="each-target-analysis-bar">
                    <p class="heading clr1">
                      ...
                      <span v-if="irResult.annual_income_increase" @click="
                        $store.dispatch(
                        ...
                        " data-bs-toggle="modal" data-bs-target="#incomeRiderScheduleTableModal">
                    ...
                    <div class="target-analysis-each-bars barClr1 text-white" ref="lineBarRef1" id="line_bar_1" :style="{
                      ...
                      <label class="amount-label-wrapper" style="padding-left: 8px" v-if="showResult >= 1">
                        ...
                        <span v-if="irResult.annual_income_increase" class="target-bar-span">Increasing by
                  ...
                  <div class="each-target-analysis-bar">
                    ...
                    <div class="target-analysis-each-bars barClr2 text-white" ref="lineBarRef2" id="line_bar_2" :style="{
                      width:
                        showResult >= 2
                  ...
                  <div class="each-target-analysis-bar">
                    <p class="heading clr3">
                      ...
                      Market Returns
                      <span v-if="irHistoricalResult.annual_income_increase" @click="
                        $store.dispatch(
                          'incomeRider/updateAnnualScheduleResultModal',
                          {
                            title: 'Increasing Annual Income Schedule',
                    ...
                    <div class="target-analysis-each-bars barClr3 text-white" ref="lineBarRef3" id="line_bar_3" :style="{
                      width:
                        showResult > 2
                      ...
                      <label class="amount-label-wrapper" style="padding-left: 8px">
                        <span v-if="showResult > 2">
                          ...
                          <span v-if="irHistoricalResult.annual_income_increase" class="target-bar-span">Increasing by
                            {{
                              $percentFormat(
                  ...
                  <hr class="numbering-top-line">
                  <div class="scalling-div all-number-div">
                    <span class="all-number-div-span" v-for="(item, index) in yearsLable" :style="`left: ${((item - (yearsLable[0])) / (yearsLable[yearsLable.length - 1] - yearsLable[0])) * 100}%`" :key="index">{{ item }}</span>
                  </div>
                  <p class="scalling-div-label">Years</p>
                  <button :class="`income-rider-show-next-btn ${showResult > 2 ? 'disable' : ''
            ...
            <div class="tab-pane fade active show" v-if="targetAnalysis == 'return'" role="tabpanel">
