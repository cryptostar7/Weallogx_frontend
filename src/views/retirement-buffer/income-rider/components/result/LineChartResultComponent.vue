    ...
    <div class="ComparativeTableMainDiv rightDivTop4 active">
        <div class="d-flex justify-content-between px-3 py-2 bb-grey tab-head">
            <div class="d-flex align-items-center">
                <label for="rightCheckBox4"
                    class="rghtTopHeadcommon nowrap">Annual Income</label>
                <label class="rghtTopHeadcommon">
                    <div class="annual-income-text-para ms-2 fs-12">
                        How long can the
                        {{inputs.comparative_vehicle_account_name}} produce the
                        same amount of income as the
                        {{inputs.income_rider_account_name}}’s Income Rider?
                    </div>
                </label>
            </div>
            <div class="rightLeftDoubleLIneDegine">
                <svg width="13" height="7" viewBox="0 0 13 7" fill="none"
                    ...
                    <rect y="5.5" width="13" height="1.5" rx="0.75"
                        fill="#C2C2C2"></rect>
        ...
        <div class="collapseDivMain collapseDiv4" style="display: block">
            ...
            <div class="px-3 pt-3 pb-2">
                <div class="d-flex justify-content-center mt-2 tab-menu">
                    <div class="nav SwtchBtnRprtBldr nav-pills" role="tablist"
                        ...
                        <div class="active" id="v-pills-annualFees1-tab"
                            data-bs-toggle="pill"
                            data-bs-target="#v-pills-annualFees1" type="button"
                            role="tab" aria-controls="v-pills-annualFees1"
                            aria-selected="true">
                            Guaranteed
                        </div>
                        <div id="v-pills-comulativeFees1-tab"
                            data-bs-toggle="pill"
            ...
            <div class="bottom-disclosure pt-0 px-3" id="disclosure1"
                data-dc="1">
