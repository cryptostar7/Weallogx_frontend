<template lang>
  <div>
    <div class="modal fade" id="GuaranteedIncreasingAnnualIncomeScheduleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="income-rider-modal-body">
              ...
              <div class="modal-scrooll-div">
                <div class="tab-content" id="nav-tabContent">
                  <div :class="`tab-pane fade ${this.inputs.guaranteed_income_type === 'mannual' ? 'show active' : ''}`" id="year-by-year-tab" role="tabpanel" aria-labelledby="year-by-year-tab">
                    ...
                    <div class="income-rider-table form-group">
                      <div class="form-group mb-0">
                        <schedule-csv-extraction prefixId="gt_income_schedule_" :maxInputs="Number(illustrateYear)" @dataUpdate="handleCSV" />
                      </div>
                          ...
                          <tr v-for="(item, index) in illustrateYear" :key="index">
                            ...
                            <td>
                              <div class="p-relative table-input-div percent-input-div">
                                <dollar-amount-input :id="`gt_income_schedule_${index + 1}`" class="form-control" max="100000000" @amountUpdated="(e) => updateSchedule(index, e)" />
                  ...
                  <div :class="`tab-pane fade ${this.inputs.guaranteed_income_type === 'year_bounded' ? 'show active' : ''}`" id="first-and-last-year-tab" role="tabpanel" aria-labelledby="first-and-last-year-tab">
                      ...
                      <table class="table tax-rate-table text-center" id="scheduleTaxRateTable">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="p-relative table-input-div percent-input-div">
                                <dollar-amount-input class="form-control" max="100000000" placeholder :default="inputs.guaranteed_income_first_year" @amountUpdated="(e) => updateInput('guaranteed_income_first_year', e)" />
                                <span class="dollar-span">$</span>
                              </div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <div class="fs-15 form_section_label_div justify-content-center">Last
                                ...
                                <label for="premium-bonus" class="main_label"><span><svg class="label-common-tooltip-svg" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    </svg><span class="text-start"> This should be the
                                      value
                                      for
                            ...
                            <td>
                              <div class="p-relative table-input-div percent-input-div">
                                <dollar-amount-input class="form-control" max="100000000" placeholder :default="inputs.guaranteed_income_last_year" @amountUpdated="(e) => updateInput('guaranteed_income_last_year', e)" />
                                <span class="dollar-span">$</span>
                              </div>
                            </td>
                          </tr>
