<template lang>
  <div>
    <div class="modal fade" id="GuaranteedIncreasingAnnualIncomeScheduleModal"
          ...
          <div class="accumulation_strategy_box">
            ...
            <div class="income-rider-modal-body">
              <div class="nav income-rider-modal-tabs table_top_tab nav-pills"
                ...
                <div
                  :class="this.inputs.guaranteed_income_type === 'manual' ? 'active' : ''"
                  data-bs-toggle="pill" data-bs-target="#year-by-year-tab"
                  type="button" role="tab" aria-controls="year-by-year-tab"
                  :aria-selected="this.inputs.guaranteed_income_type === 'manual'"
                  @click="updateInput('guaranteed_income_type', 'manual')">
                  Year by Year
                </div>
                <div
              ...
              <div class="modal-scrooll-div">
                <div class="tab-content" id="nav-tabContent">
                  <div
                    :class="`tab-pane fade ${this.inputs.guaranteed_income_type === 'manual' ? 'show active' : ''}`"
                    id="year-by-year-tab" role="tabpanel"
                    ...
                    <div class="income-rider-table form-group">
                      <div class="form-group mb-0">
                        <schedule-csv-extraction prefixId="gt_income_schedule_"
                  ...
                  <div
                    ...
                    id="first-and-last-year-tab" role="tabpanel"
