<template>
  <div>
    ...
    <div class="accumulation_strategy_inner_box">
      ...
      <p class="form_section_para mt-3" data-bs-toggle="modal" data-bs-target="#mismatchIncomeModal">Income Rider Details</p>
      <div class="row mb-3">
        <div class="col-md-4 col-lg-3 mb-3">
          <div class="form_section_label_div">
  ...
  <div class="modal fade common-modal" id="mismatchIncomeModal" tabindex="-1" aria-labelledby="mismatchIncomeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          <img src="@/assets/images/icons/grey-error.svg" alt="Error" width="65" />
          <p class="fs-14 mt-3">Your non-guaranteed income start year differs <br> from the guaranteed income start year schedule. They must match. <br> Please amend one or the other so that both schedules <br> have the same start year.</p>
          <div class="d-inline-flex pt-4 mt-2 pb-2">
            <button type="button" class="btn modal-cancel-btn" data-bs-dismiss="modal">OKAY</button>
          </div>
        </div>
      </div>
    </div>
