            ...
            <div class="right-area-wrapper">
              <section class="padding_right_section">
                <div class="retirement_buffer_section_head_div mb-5">
                  ...
                  <div
                    class="nav table_graph_setting_tab nav-pills top-0"
                    role="tablist"
                    aria-orientation="vertical"
                  >
                    <div
                      @click="resultViewHandler"
                      class="active"
                      data-bs-toggle="pill"
                    ...
                    >
                      <svg
                        class="income-rider-tab-svg income-svg-2"
                        width="28"
                        height="27"
                        viewBox="0 0 28 27"
                        fill="none"
                      ...
                      >
                        <g clip-path="url(#clip0_6993_46716)">
                          ...
                          >
                            <path
                              d="M3 0.125H27.1927V24.3177H3V0.125Z"
                              fill="white"
                            />
                          </mask>
                        ...
                        >
                          <path
                            d="M2 24.125H26.1927V26.625H2V24.125Z"
                            fill="white"
                          />
                        </mask>
                        ...
                        >
                          <path
                            d="M0 26.1953L0 0.0026859H2.5L2.5 26.1953H0Z"
                            fill="white"
                          />
                        </mask>
                  ...
                  <router-link
                    to="/retirement-buffer/income-rider"
                    class="head_back_btn"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
