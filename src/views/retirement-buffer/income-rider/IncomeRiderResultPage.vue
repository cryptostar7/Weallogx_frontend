<template>
  <div v-if="result">
              ...
              <section class="padding_right_section">
                <div class="retirement_buffer_section_head_div mb-5">
                  ...
                  <div class="nav table_graph_setting_tab nav-pills top-0"
                    ...
                    <div class="active" data-bs-toggle="pill"
                    ...
                    <div data-bs-toggle="pill" data-bs-target="#v-pills-graph"
    ...
    <div class="modal fade" id="incomeRiderTableModal2" tabindex="-1"
      aria-labelledby="incomeRiderTableModal2" aria-hidden="true">
      <a type="button" data-bs-dismiss="modal" class="preview-modal-close">
        <svg width="45" height="48" viewBox="0 0 45 48" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <g id="Group 1974" filter="url(#filter0_d_346_5079)">
          ...
          <div class="accumulation_strategy_box">
            ...
            <div class="income-rider-modal-body">
              <div class="nav income-rider-modal-tabs table_top_tab nav-pills"
                role="tablist" aria-orientation="vertical">
                <div class="active" data-bs-toggle="pill"
                  data-bs-target="#year-by-year-tab" type="button" role="tab"
                  aria-controls="year-by-year-tab" aria-selected="true">
                  Year by Year
                </div>
                <div data-bs-toggle="pill"
                  data-bs-target="#first-and-last-year-tab" type="button"
                  role="tab" aria-controls="first-and-last-year-tab"
                  aria-selected="false">
                  First and Last Year
                </div>
              </div>
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="year-by-year-tab"
                  role="tabpanel" aria-labelledby="year-by-year-tab">
                  <p class="para">
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                ...
                                id="schedule_tax_rate_1" min="1" max="99"
                                placeholder />
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_2" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_3" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_4" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_5" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_6" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_7" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_8" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_9" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_10" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_11" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_12" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_13" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_14" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_15" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_16" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_17" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_18" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_19" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_20" min="1" max="99"
                                placeholder />
                              <span class="dollar-span">$</span>
                            </div>
                          </td>
                ...
                <div class="tab-pane fade" id="first-and-last-year-tab"
                  role="tabpanel" aria-labelledby="first-and-last-year-tab">
                  <p class="para">
                        ...
                        <tr>
                          ...
                          <td>
                            <div
                              ...
                              <input type="number"
                                class="form-control handleLimit"
                                id="schedule_tax_rate_100" min="1" max="99"
                                placeholder /><span class="dollar-span">$</span>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <div
                              class="fs-15 form_section_label_div justify-content-center">
                              Last Year
                              <label for="premium-bonus"
                                class="main_label"><span><svg
                                    class="label-common-tooltip-svg" width="13"
                                    height="13" viewBox="0 0 13 13" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="Group 1968">
                                      <circle id="Ellipse 190" cx="6.5" cy="6.5"
                                        r="6.5" fill="#D0D0D0"></circle>
                                      <circle id="Ellipse 191" cx="6.5" cy="3.5"
                                        r="1" fill="white"></circle>
