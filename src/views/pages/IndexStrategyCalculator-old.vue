              ...
              <section class="strategy-calc-main-section mt-3 pt-4">
                <div class="strategy-calc-main-div">
                  ...
                  <div class="index-strategy-content-div">
                    <div class="index-strategy-content-inner-div withBoxShadow">
                      <div class="index-strategy-each-tabs-head">
                        <p>Index Vehicle Parameters <span>Compare a taxable or pre-tax vehicle using an index to a risk-mitigated tax-free strategy</span></p>
                        <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <g id="Clip path group" filter="url(#filter0_d_332_2464)">
                            <mask id="mask0_332_2464" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="4" y="2" width="24" height="25">
                               <g id="461b897740">
                          ...
                          <defs>
                            ...
                            <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_332_2464"/>
                            <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_332_2464" result="shape"/>
                            </filter>
                          </defs>
                        </svg>  
                      </div>
                      <div class="container-fluid index-strategy-inputs-div">
                        <div class="row">
                          ...
                          <div class="col-md-6 col-lg-3 inp-mar-top">
                            <label for="beginningBalance">Tax Rate <span>
                              <svg class="label-common-tooltip-svg" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="Group 1968">
                                  <circle id="Ellipse 190" cx="6.5" cy="6.5" r="6.5" fill="#D0D0D0"/>
                                  <circle id="Ellipse 191" cx="6.5" cy="3.5" r="1" fill="white"/>
                                  <rect id="Rectangle 753" x="5.75" y="5.5" width="1.5" height="5" rx="0.75" fill="white"/>
                                </g>
                              </svg>
                                <span>Choose your tax rate. This will remain constant between each index strategy.</span>
                              </span>
                            </label>
                          ...
                          <div class="col-md-6 col-lg-3 inp-mar-top">
                            <label for="beginningBalance">Index Vehicle Fee <span>
                              <svg class="label-common-tooltip-svg" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="Group 1968">
                                  <circle id="Ellipse 190" cx="6.5" cy="6.5" r="6.5" fill="#D0D0D0"/>
                                  <circle id="Ellipse 191" cx="6.5" cy="3.5" r="1" fill="white"/>
                                ...
                                <span>What fee would you like to assume for the Index Vehicle?</span>
                                </span>
                              </label>
                              <div class="index-strategy-each-inputs">
                      ...
                      <div class="strategy-parameter-main-div">
                        ...
                        <div class="d-flex justify-content-center">
                          <div class="multi-radio-main-div">
                              <div class="form-check form-switch each-radio-switch radioClassDarkMode active">
                                <input class="form-check-input" type="checkbox" role="switch" data-number="0" id="1" checked>
                                <label class="each-radio-label">1</label>
                              </div>
                            <div class="form-check form-switch each-radio-switch radioClassDarkMode">
                              <input class="form-check-input" type="checkbox" role="switch" data-number="1" id="2">
                              <label class="each-radio-label">2</label>
                            </div>
                            <div class="form-check form-switch each-radio-switch radioClassDarkMode">
                              <input class="form-check-input" type="checkbox" role="switch" data-number="2" id="3">
                              <label class="each-radio-label" id="historicalTopCheckBoxDiv3">3</label>
                            </div>
                          </div>
                        </div>
                        <p class="strategy-allocation-head-para">Strategy Allocation <span>
                          <svg class="label-common-tooltip-svg" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="Group 1968">
                            <circle id="Ellipse 190" cx="6.5" cy="6.5" r="6.5" fill="#D0D0D0"/>
                            <circle id="Ellipse 191" cx="6.5" cy="3.5" r="1" fill="white"/>
                        ...
                        <div class="strategy-allocation-all-div */error*/">
                          <div class="strategy-allocated-div active">
                            <input type="text" class="form-control allocation-input" value="100%">
                          </div>
                          <div class="strategy-allocated-div">
                            <input type="text" class="form-control allocation-input" disabled>
                          </div>
                          <div class="strategy-allocated-div">
                            <input type="text" class="form-control allocation-input" disabled>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <rect id="Rectangle 753" x="5.75" y="5.5" width="1.5" height="5" rx="0.75" fill="white"/>
                              ...
                              <div class="three-radio-button-input-div">
                                <div>
                                  <input type="radio" name="segment-duration" id="segmentDuration1" hidden checked>
                                  <label for="segmentDuration1">1</label>
                                </div>
                                <div>
                                  <input type="radio" name="segment-duration" id="segmentDuration2" hidden>
                                  <label for="segmentDuration2">2</label>
                                </div>
                                <div>
                                  <input type="radio" name="segment-duration" id="segmentDuration3" hidden>
                                  <label for="segmentDuration3">3</label>  
                                </div>                              
                              </div>
                            </div>
                            <div class="col-md-6 col-lg-3 inp-mar-top">
                              <label for="beginningBalance">Cap Rate <span><svg class="label-common-tooltip-svg" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="Group 1968">
                            <circle id="Ellipse 190" cx="6.5" cy="6.5" r="6.5" fill="#D0D0D0"/>
                            <circle id="Ellipse 191" cx="6.5" cy="3.5" r="1" fill="white"/>
                            <rect id="Rectangle 753" x="5.75" y="5.5" width="1.5" height="5" rx="0.75" fill="white"/>
                            ...
                            <div class="col-md-6 col-lg-3 inp-mar-top">
                              <label for="beginningBalance">Margin <span><svg class="label-common-tooltip-svg" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="Group 1968">
                            <circle id="Ellipse 190" cx="6.5" cy="6.5" r="6.5" fill="#D0D0D0"/>
                            <circle id="Ellipse 191" cx="6.5" cy="3.5" r="1" fill="white"/>
                            <rect id="Rectangle 753" x="5.75" y="5.5" width="1.5" height="5" rx="0.75" fill="white"/>
                                  ...
                                  <span>If your strategy uses a margin/spread, enter it here. Many multiyear strategies
                                    express the margin annually. For example, a 2 year strategy might use a margin of 3%
                                    annually. You would put 6% here, in that case. If none, leave blank or put 0.</span>
                                </span></label>
                              <div class="index-strategy-each-inputs">
                                <input type="text" required>
                                <span>%</span>
                            ...
                            <div class="col-md-6 col-lg-3 inp-mar-top">
                              <label for="beginningBalance">Flat Credit/Bonus <span><svg class="label-common-tooltip-svg" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="Group 1968">
                            <circle id="Ellipse 190" cx="6.5" cy="6.5" r="6.5" fill="#D0D0D0"/>
                            <circle id="Ellipse 191" cx="6.5" cy="3.5" r="1" fill="white"/>
                            <rect id="Rectangle 753" x="5.75" y="5.5" width="1.5" height="5" rx="0.75" fill="white"/>
                            ...
                            <div class="col-md-6 col-lg-3 inp-mar-top">
                              <label for="beginningBalance">Strategy Fee<span><svg class="label-common-tooltip-svg" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="Group 1968">
                            <circle id="Ellipse 190" cx="6.5" cy="6.5" r="6.5" fill="#D0D0D0"/>
                            <circle id="Ellipse 191" cx="6.5" cy="3.5" r="1" fill="white"/>
                            <rect id="Rectangle 753" x="5.75" y="5.5" width="1.5" height="5" rx="0.75" fill="white"/>
                  ...
                  <div class="run-reset-btn-div">
                    <router-link to="/index-strategy-calculator-run" class="run-button /*disabled*/">Run</router-link>
                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#resetModal" class="reset-button">Reset</a>
                  </div>
                </div>
              </section>
            </div>
...
export default {
  ...
  let selectBtn = document.querySelectorAll(".select-btn");
    ...
    const threeCheckboxContainers = document.querySelectorAll(".each-radio-switch");
    const threeCheckInputs = document.querySelectorAll(".form-check-input");
    const strategyAllocatedDivs = document.querySelectorAll(".strategy-allocated-div");
    const allocationInputs = document.querySelectorAll(".strategy-allocated-div input");
    ...
    allocationInputs.forEach(input => {
      input.addEventListener("focusout", (e) => {
        ...
        let val1 = Number(allocationInputs[0].value.substr(0, allocationInputs[0].value.length-1));
        let val2 = Number(allocationInputs[1].value.substr(0, allocationInputs[1].value.length-1));
        let val3 = Number(allocationInputs[2].value.substr(0, allocationInputs[2].value.length-1));
        
        let total = val1+val2+val3;
        if(total > 100){
          document.querySelector(".strategy-allocation-all-div").classList.add("error");
        }else{
          document.querySelector(".strategy-allocation-all-div").classList.remove("error");
        }
