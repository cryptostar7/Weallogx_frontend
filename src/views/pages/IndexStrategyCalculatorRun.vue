            ...
            <div class="right-area-inner p-relative rightInnerDarkbg">
              <div class="right-area-wrapper pt-0 pb-3">
                ...
                <section class="strategy-calc-main-section mt-0">
                  <p class="disclosure_bottom_para mt-4"><span>Disclosure:</span> This program illustrates a hypothetical scenario of certain index strategies that may be available and compares it to a hypothetical direct investment into those index(es). Importantly, it does not illustrate a cash-value life insurance policy. It is meant to be educational and insightful of how certain index strategies (absent policy fees) within certain types of cash-value life insurance may have behaved through a historical lens. Though this is meant to give insight and provide discussion points, and every good faith effort has been made to help ensure accuracy, the approach is inherently imperfect. You may not infer that the results portrayed would have been those of a cash-value life insurance policy that offers similar index strategies. If this program were illustrating an actual insurance policy, which it is not, costs related to the policy would materially reduce the values shown, as would fees (including taxes) relating to a direct investment in any index(es).</p>
                </section>
              </div>
            </div>
          </main>
