                                ...
                                <div class="col-6 half-col half-col-left">
                                  ...
                                  <div class="table-responsive w-100 mt-2">
                                    <table class="index-strategy-table">
                                      ...
                                      <tbody v-if="index_calculations">
                                        <tr
                                          v-for="(
                                            item, index
                                          ) in index_calculations"
                                          :key="index"
                                        >
                                          <td>{{ item.year }}</td>
                                          <td
                                ...
                                <div class="col-6 half-col half-col-right">
                                  ...
                                  <div class="table-responsive w-100 mt-2">
                                    <table class="index-strategy-table">
                                      ...
                                      <tbody v-if="strategy_calculations">
                                        <tr
                                          v-for="(
                                            item, index
                                          ) in strategy_calculations"
                                          :key="index"
                                        >
                                          <td>{{ item.year }}</td>
                                          <td
                          ...
                          <div class="container-fluid px-0">
                            <div class="row">
                              ...
                              <div class="col-sm-4">
                                <p>
                                  ${{
                                    index_summary.beginning_balance
                                      ? index_summary.beginning_balance.toFixed(
                                          2
                                        )
                                      : 0
                                  }}
                              ...
                              <div class="col-sm-8">
                                <p>
                                  ...
                                  <span class="tooltips"
                                    ...
                                    <span class="w-225"
                                      >Represents the net ending balance after
                                      all taxes and fees</span
                                    >
                                  </span>
                                </p>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-4">
                                <p
                                  :class="
                                    index_summary.total_negative_years < 0
                                      ? 'highlighted'
                                      : ''
                                  "
                                >
                                  {{ index_summary.total_negative_years }}
                                </p>
                              </div>
                            </div>
                            <div class="row">
                                ...
                                <p class="p-relative">
                                  ...
                                  <span class="tooltips"
                                    ...
                                    <span class="w-250"
                                      ...
                                      a more accurate measure of a portfolio’s
                                      performance</span
                                    >
                                  </span>
                                  <button
...
export default {
  ...
  data() {
    return {
      index_calculations: null,
      index_summary: null,
      strategy_calculations: null,
      strategy_summary: null,
      inputs: [],
    };
  },
  mounted() {
    // let isc_calculate = JSON.parse(localStorage.getItem("isc_calculate"));
    let isc_calculate = {
      index_results: {
        rate_of_return: {
          0: 0.0,
    ...
    this.mapData(isc_calculate);
    this.inputs = JSON.parse(localStorage.getItem("isc_calculate_inputs"));
  },
  methods: {
    testFunction: function () {
      console.log(this.inputs);
      console.log(this.index_calculations);
      console.log(this.strategy_calculations);
    },
    mapData: function (data) {
      ...
      this.index_calculations = index_results;
      this.strategy_calculations = strategy_results;
