                    ...
                    <div class="index-strategy-content-inner-div withBoxShadow">
                      <div class="index-strategy-each-tabs-head">
                        <p>
                          ...
                          <span
                            >Compare a taxable or pre-tax vehicle using an index
                            to a risk-mitigated tax-free strategy</span
                          >
                        </p>
                        <svg
                          width="32"
                          ...
                          <div class="col-md-6 col-lg-3 inp-mar-top">
                            <label for="beginningBalance"
                              ...
                              <span>
                                ...
                                <span
                                  >Choose your tax rate. This will remain
                                  constant between each index strategy.</span
                                >
                              </span>
                            </label>
                          ...
                          <div class="col-md-6 col-lg-3 inp-mar-top">
                            <label for="beginningBalance"
                              ...
                              <span>
                                ...
                                <span
                                  >What fee would you like to assume for the
                                  Index Vehicle?</span
                                >
                              </span>
                            </label>
                      ...
                      <div class="strategy-parameter-main-div">
                        ...
                        <p class="strategy-allocation-head-para">
                          ...
                          <span>
                            ...
                            <span
                              >Total allocation of all strategies must be
                              100%.</span
                            >
                          </span>
                        </p>
