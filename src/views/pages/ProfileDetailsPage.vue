        ...
        <section class="authMaindiv-area">
            ...
            <div class="payment-methodMain-div paymentMiddleDivMain">
                ...
                <div class="profile-edit-btn-main-div">
                    ...
                    <p class="pro-details-name">Allianz Parse</p>
                    </div>
                    <div>
                ...
                <div class="profile-all-details-mainDiv">
                    ...
                    <div class="profile-each-details">
                        ...
                        <div>
                        <h6>Business Name :</h6>
                        <p>XYZ Private limited company</p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="profile-each-details">
                        ...
                        <div>
                        <h6>Address :</h6>
                        <p>123 N Main Street, 3rd Floor, New York 10018</p>
                        </div>
                    </div>
                    </div>
                </div>
                <div class="bottomYourCompanyLogo">
                    <div>
                    <h6>Your Company Logo</h6>
                    <div class="companyLogoDiv">
                        <img src="@/assets/images/user/wealthlogix-logo.png" alt="LOGO">
                    </div>
                    </div>
                </div>
                </div>
