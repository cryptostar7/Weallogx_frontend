<template lang="">
      ...
      <div class="container middleContainer">
        ...
        <div class="payment-methodMain-div paymentMiddleDivMain">
          ...
          <div class="d-flex flex-column">
            <div v-if="user" class="w-100 payment-right-card-main-div dashBoardRightDiv">
            ...
            <div class="text-center w-100 delete-account-div mt-3 pt-1">
              <button class="btn" data-bs-target="#deleteAccountModal" data-bs-toggle="modal">Delete Account</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="modal fade common-modal" id="deleteAccountModal" tabindex="-1" aria-labelledby="deleteReportModalLabel"  aria-modal="true" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body text-center">
          <h5 class="modal-title fs-24 semi-bold-fw" id="deleteReportModalLabel">Delete Account?</h5>
          <p class="fs-14">This action cannot be undone. To start again, you've to create a new account and proceed from the scratch.</p>
          <div class="d-inline-flex flex-column gap-13 pt-4 mt-2 pb-2">
            <button type="button" class="btn yes-delete-btn" data-bs-dismiss="modal">Yes, Delete</button><button type="button" class="btn modal-cancel-btn" data-bs-dismiss="modal">Cancel</button>
          </div>
        </div>
      </div>
    </div>
